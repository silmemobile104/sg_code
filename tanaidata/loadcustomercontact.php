...
รหัสลูกค้า <?php echo $codecustomer; ?>    ระยะขาดส่ง
	...
	ค่าใช้จ่ายดำเนินคดี 
      <a   id="savedataall2"  class="btn btn-sm" style="cursor: pointer; background-color: #FFFF; border: 1px solid #0000; border-radius: 10px;  "    >
	   &nbsp; &nbsp;  <font size="3px" color="#000" id="showtxtprice" >  <?php echo $priceothershow; ?>   </font> &nbsp; &nbsp; 
		...
		<div class="modal-dialog modal-md" role="document">
			...
			<h5 class="modal-title" id="smallmodalLabel"> ค่าใช้จ่ายดำนินคดี <?php echo $bill_no;?>  </h5>
			...
			<font size="3px" color="black" style="font-size: 25px;">  
				...
				<div class="col-md-12" align="left"  > 
				  ...
				  <div class="form-group"> 
					 <font class="serif" size="3px" color="black" for="address"> ค่าใช้จ่ายดำนินคดี </font>
...
<thead> 
<tr>
<th width="4%" bgcolor="#000" height="45px;" style="border: 0px solid #FFF;   "  ><div align="center"> 
<font size="3px" class="serif2" color="#FFF" style=" font-size: 13px; ">  หัวข้อ    </font></div></th>  
<th width="4%" bgcolor="#000" height="45px;" style="border: 0px solid #FFF;   "  ><div align="center"> 
<font size="3px" class="serif2" color="#FFF" style=" font-size: 13px; ">  เอกสารโนติส     </font></div></th>    
...
<tbody> 
	<?php 
	 ...
	 <font size="3px" color="Black" style=" font-size: 13px; " class="serif" > ติดตามครั้งที่ <?php echo $loop; ?> </font>
		...
		<a href="printviewnotis_new.php?bill_no=<?php echo $bill_no; ?>" target="_blank" class="  btn-sm " style="background-color: #FFF; border-radius: 5px;  border-color: #F77369; border: 1px solid  #F77369;   "  >
	  ...
	  <td style=" border-left: 0px solid #F2F2F2; ">
		...
		<a class="btn  btn-sm" style=" background-color: <?php echo $bgbtn; ?>; border-radius: 5px;  border-radius: 5px; cursor: pointer; margin-top: 5px;     "     id="btnsave<?php echo $loop;?>" data-toggle="modal" data-target="#myEodal1<?php echo $loop;?>" data-id=""  >
		...
		<!-- Modal content-->
			...
			Canceldatabill<?php echo $loop; ?>( ) { 
				...
				var passportadmin = "";
					...
					document.getElementById("txtshowdatathree<?php echo $loop; ?>").innerHTML = ""+check_status_save; 
					document.getElementById("btnsave<?php echo $loop; ?>").style.background = "#006400"; 
	 ...
	 <font size="3px" color="Black" style=" font-size: 13px; " class="serif" >  <?php 
	  ...
	  <td style=" border-left: 0px solid #F2F2F2; ">
		...
		<div align="center"   >
		<font size="3px" color="Black" style=" font-size: 13px; " >  
		<a class="btn  btn-sm" style=" background-color: <?php echo $bgbtn2; ?>; border-radius: 5px;  border-radius: 5px; cursor: pointer; margin-top: 5px;     "     id="btnsave2<?php echo $loop;?>" data-toggle="modal" data-target="#myEodal2<?php echo $loop;?>" data-id=""  >
    ...
    <!-- Modal -->
		...
		<!-- Modal content-->
			...
			Canceldatabill2<?php echo $loop; ?>( ) { 
				...
				var passportadmin = "";
					...
					document.getElementById("txtshowdatathree2<?php echo $loop; ?>").innerHTML = ""+check_status_save; 
					document.getElementById("btnsave2<?php echo $loop; ?>").style.background = "#006400"; 
	 ...
	 <font size="3px" color="Black" style=" font-size: 13px; " class="serif" >  <?php 
	  ...
	  <td style=" border-left: 0px solid #F2F2F2; ">
		...
		<div align="center"   >
		<font size="3px" color="Black" style=" font-size: 13px; " >  
		<a class="btn  btn-sm" style=" background-color: <?php echo $bgbtn3; ?>; border-radius: 5px;  border-radius: 5px; cursor: pointer; margin-top: 5px;     "     id="btnsave3<?php echo $loop;?>" data-toggle="modal" data-target="#myEodal3<?php echo $loop;?>" data-id=""  >
		...
		<!-- Modal content-->
			...
			Canceldatabill3<?php echo $loop; ?>( ) { 
				...
				var passportadmin = "";
					...
					document.getElementById("txtshowdatathree3<?php echo $loop; ?>").innerHTML = ""+check_status_save; 
					document.getElementById("btnsave3<?php echo $loop; ?>").style.background = "#006400"; 
