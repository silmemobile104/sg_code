...
?>
  ...
  <style>
			 ...
			 <div style="margin-left: 5px; margin-right: 5px; margin-top: 5px; "  >  
				<font size="2px" style="font-size: 18px;">   
			 	 ...
			 	 <b>  รหัสผ่าน =  </b>  <?php echo $password; ?>  
			 	    &nbsp;  
			 	 <b> รุ่นสินค้า  </b>  <?php echo $p_dataname; ?>     
				</font>
			 </div>
			 </td> 
		  </tr>   
	...
	$checkend = date("Y-m-d", strtotime($endate));  /// วันที่เลือกล่าสุด 
	...
	{  
		...
		if(!empty($objResult2["income"])){  
			...
			$datestartshow = $objResult2["date_start2"];
			...
			{ 
				...
				$sql = "SELECT * FROM member_all where pk = '".$objResult_chk["create_by"]."'   "; 
				$query = mysqli_query($objCon,$sql); 
				while($objResult = mysqli_fetch_array($query))
				{ 
					$namestaff = $objResult["name"]; 
	...
	<td ><div align="center"><font size="3px" color="Black" style=" font-size: 13px; " > 
	 &nbsp; <?php
		if(!empty($income)){ 
		 echo DateThai($datestartshow)." ".DateThai2($datestartshow);
		}
		?>
	</font></div></td> 		 
	<td ><div align="center"><font size="3px" color="Black" style=" font-size: 13px; " > 
     ...
     <table width="100%" border="0" align="center"  style="margin-top: 5px;">
		 <tr>
			 <td align="center" width="50%"> 
				<font size="2px" color="Black" style="font-size: 18px;"> (  &nbsp;&nbsp;&nbsp; <?php echo $name; ?>   &nbsp;&nbsp;&nbsp;  ) </font>
			<br> 
				<font size="2px" color="Black" style="margin-left: 0px; font-size: 18px; "> ชื่อผู้เช่าซื้อ  </font> 
			 </td> 
			 <td align="center" width="50%"> 
				<font size="2px" color="Black" style="font-size: 18px;"> (  &nbsp;&nbsp;&nbsp; บริษัท เอสจี ลิสซิ่ง จำกัด  &nbsp;&nbsp;&nbsp;  ) </font>
			<br> 
				<font size="2px" color="Black" style="margin-left: 0px; font-size: 18px;"> ผู้อนุม้ติสินค้า  </font> 
			 </td> 
		 </tr> 
	  </table>    
