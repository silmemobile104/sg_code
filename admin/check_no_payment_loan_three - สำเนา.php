                     ...
                     <font size="4px" color="#000000">  ข้อมูลสงสัยหนี้จะศูนย์  กรณีเลย3 เดือน </font>   
                      ...
                      <?php if(empty($_GET["page"])){ ?>
                           ...
                           <?php if(!empty($major)){   ?> 
							...
							<th width="5%" bgcolor="#BEC6CB" style="border: 0px solid #FFF;  border-right: 1px solid #FFF;  "><div align="center"> 
							<font size="3px" class="serif2" color="#000" style=" font-size: 10px; ">  ติดตาม ครั้งที่ 1     </font></div></th> 
							
							<th width="5%" bgcolor="#BEC6CB" style="border: 0px solid #FFF;  border-right: 1px solid #FFF;  "><div align="center"> 
							<font size="3px" class="serif2" color="#000" style=" font-size: 10px; ">  ติดตาม ครั้งที่ 2     </font></div></th> 
							
							<th width="5%" bgcolor="#BEC6CB" style="border: 0px solid #FFF;  border-right: 1px solid #FFF;  "><div align="center"> 
							<font size="3px" class="serif2" color="#000" style=" font-size: 10px; ">  ติดตาม ครั้งที่ 3     </font></div></th> 
							
							<th width="5%" bgcolor="#BEC6CB" style="border: 0px solid #FFF;  border-right: 1px solid #FFF;  "><div align="center"> 
							<font size="3px" class="serif2" color="#000" style=" font-size: 10px; ">   ดำเนินดคดี     </font></div></th> 
							...
							<font size="3px" class="serif2" color="#000" style=" font-size: 10px; ">  หมายเหตุ   </font></div></th>  
								...
								<tbody>
										...
										<?php if($objResult2["onoff_copy"] == "ปกติ"){ ?>
										 ...
										 <select class="form-control " style="background-color: #006400; color: white; font-size: 10px;  margin-top: -5px;  " id="status_paymentnpl<?php echo $objResult2["pk"]; ?>" name="status_paymentnpl<?php echo $objResult2["pk"]; ?>" onChange="showUsernpl<?php echo $objResult2["pk"]; ?>(this.value)"  > 
										...
										<?php }else if($objResult2["onoff_copy"] == "NPL"){ ?>
										 ...
										 <select class="form-control " style="background-color: #FFA500; color: white; font-size: 10px;  margin-top: -5px;  " id="status_paymentnpl<?php echo $objResult2["pk"]; ?>" name="status_paymentnpl<?php echo $objResult2["pk"]; ?>" onChange="showUsernpl<?php echo $objResult2["pk"]; ?>(this.value)"  > 
									    ...
									    <td style=" border-left: 0px solid #F2F2F2; "><div align="center"><font size="3px" color="Black" style=" font-size: 10px; " >      
										 <select class="form-control " style="background-color: #006400; color: white; font-size: 10px;  margin-top: -5px;  " id="statusnew1<?php echo $objResult2["pk"]; ?>" name="statusnew1<?php echo $objResult2["pk"]; ?>" onChange="showstatusnew1<?php echo $objResult2["pk"]; ?>()"  > 
										  <?php if(empty($objResult2["statusnew1"])){ ?>
											<option value=""> โปรดเลือก </option>
											<?php } ?>
											<?php 
											$sql_pay = "SELECT * FROM drop_statusnew where name = '".$objResult2["statusnew1"]."' order by pk asc  "; 
									    ...
									    <td style=" border-left: 0px solid #F2F2F2; "><div align="center"><font size="3px" color="Black" style=" font-size: 10px; " >      
										 <select class="form-control " style="background-color: #006400; color: white; font-size: 10px;  margin-top: -5px;  " id="statusnew2<?php echo $objResult2["pk"]; ?>" name="statusnew2<?php echo $objResult2["pk"]; ?>"  onChange="showstatusnew1<?php echo $objResult2["pk"]; ?>()"  > 
										  <?php if(empty($objResult2["statusnew2"])){ ?>
											<option value=""> โปรดเลือก </option>
											<?php } ?>
											<?php 
											$sql_pay = "SELECT * FROM drop_statusnew where name = '".$objResult2["statusnew2"]."' order by pk asc  "; 
											$query_pay = mysqli_query($objCon,$sql_pay);
											while($objResult_pay = mysqli_fetch_array($query_pay))
											{ 
											?>
									    ...
									    <td style=" border-left: 0px solid #F2F2F2; "><div align="center"><font size="3px" color="Black" style=" font-size: 10px; " >      
										 <select class="form-control " style="background-color: #006400; color: white; font-size: 10px;  margin-top: -5px;  " id="statusnew3<?php echo $objResult2["pk"]; ?>" name="statusnew3<?php echo $objResult2["pk"]; ?>"  onChange="showstatusnew1<?php echo $objResult2["pk"]; ?>()" > 
										  <?php if(empty($objResult2["statusnew3"])){ ?>
											<option value=""> โปรดเลือก </option>
											<?php } ?>
											<?php 
											$sql_pay = "SELECT * FROM drop_statusnew where name = '".$objResult2["statusnew3"]."' order by pk asc  "; 
											$query_pay = mysqli_query($objCon,$sql_pay);
											while($objResult_pay = mysqli_fetch_array($query_pay))
											{ 
											?>
									    ...
									    <td style=" border-left: 0px solid #F2F2F2; "><div align="center"><font size="3px" color="Black" style=" font-size: 10px; " >      
										 <select class="form-control " style="background-color: #006400; color: white; font-size: 10px;  margin-top: -5px;  " id="statusnew4<?php echo $objResult2["pk"]; ?>" name="statusnew4<?php echo $objResult2["pk"]; ?>"  onChange="showstatusnew1<?php echo $objResult2["pk"]; ?>()"  > 
										  <?php if(empty($objResult2["statusnew4"])){ ?>
											<option value=""> โปรดเลือก </option>
											<?php } ?>
											<?php 
											$sql_pay = "SELECT * FROM drop_statusnew2 where name = '".$objResult2["statusnew4"]."' order by pk asc  "; 
											$query_pay = mysqli_query($objCon,$sql_pay);
											while($objResult_pay = mysqli_fetch_array($query_pay))
											{ 
											?>
