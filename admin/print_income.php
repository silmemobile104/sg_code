...
?>
  ...
  <style>
	...
	$total_p = 0;
	$sql = "SELECT * FROM member_bank where member = '".$member."' and major = '".$major."'  and typedata = 'ฝากเงิน' and pk  <= '".$pkcheck."'
	order by pk desc   ";  
	...
	$total_d = 0;
	$sql = "SELECT * FROM member_bank where member = '".$member."' and major = '".$major."'  and typedata = 'ถอนเงิน' and pk  < '".$pkcheck."' 
	order by pk desc "; 
	$query = mysqli_query($objCon,$sql); 
	while($objResult = mysqli_fetch_array($query))
	{ 
			 ...
			 <td align="left" width="60%" valign="top"  >   
				<font size="2px" style="font-size: 19px;">   
			 	 ...
			 	 <b> &nbsp; ข้อมูลผู้ฝากเงิน  </b>  <?php echo $namemember1;  ?>  โทร.  <?php echo $namemember2;  ?>  
		 	 	 <div style="margin-top: 5px; ">  </div>
			 	 <b> &nbsp; ยอดเงินฝาก   </b>   <?php echo number_format(0+$price); ?> บาท   
		 	 	 <div style="margin-top: 5px; ">  </div>
			 	 <b> &nbsp; ยอดเงินฝากคงเหลือ   </b>   <?php echo number_format(0+$sumall); ?> บาท   
		 	 	 <div style="margin-top: 5px; ">  </div>
				</font> 
			 </td> 
