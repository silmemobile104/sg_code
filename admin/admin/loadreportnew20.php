...
?>
	...
	<thead>  
	 <tr>
		...
		<font size="3px" class="serif2" color="#000" style=" font-size: 15px; "> ยอดขายสินค้า  </font></div></th>       
		<th width="3%" bgcolor="#E2E7EC" style="border: 0px solid #FFF;  border-right: 1px solid #FFF;  "><div align="center"> 
		<font size="3px" class="serif2" color="#000" style=" font-size: 15px; "> ต้นทุนขายสินค้า  </font></div></th>       
		<th width="3%" bgcolor="#E2E7EC" style="border: 0px solid #FFF;  border-right: 1px solid #FFF;  "><div align="center"> 
	...
	<?php  
	   ...
	   for($x = 1; $x <= 12; $x++){
		...
		$sql2 = "  SELECT * FROM list_order_store  where bill_no != ''  ".$addcode_re."   order by  pk asc  ";   
		...
		{         
		   ...
		   $totaldata3 = $totaldata1-$price1;
		   $loopdataall += $totaldata1-$price1;
	?>
	 <tr>
