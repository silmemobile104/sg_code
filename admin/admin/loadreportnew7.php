...
?>
	...
	<thead>  
	 <tr>
		...
		<font size="3px" class="serif2" color="#000" style=" font-size: 15px; "> ยอดชำระเงินค่าปรับ  </font></div></th>       
		<th width="3%" bgcolor="#E2E7EC" style="border: 0px solid #FFF;  border-right: 1px solid #FFF;  "><div align="center"> 
	...
	<?php  
	   ...
	   for($x = 1; $x <= 12; $x++){
		...
		Where  a.price != ''  and b.contactstatus = 'อนุมัติแล้ว'    ".$addcode." order by a.pk desc    ";  
