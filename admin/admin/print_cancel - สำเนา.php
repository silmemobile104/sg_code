			 ...
			 <td align="left" width="100%" valign="top"  >   
				<font size="2px" style="font-size: 16px;">   
				 ...
				 จำนวนงวด <?php echo  number_format(0+$daytotal); ?>  งวด
		 	 	 <div style="margin-top: 5px; ">  </div> 
				 เงินดาวน์ <?php echo  number_format(0+$moneydown); ?> ยอดผ่อนชำระ <?php echo  number_format(0+$discoount); ?> ยอดรวม <?php echo  number_format(0+$endback); ?> คืนให้ลูกค้า <?php echo  number_format(0+$c_price_back); ?> ยอดที่บริษัทได้รับ <?php echo  number_format(0+$c_company); ?> 
		 	 	 <div style="margin-top: 5px; ">  </div> 
		 	 	 </div> 
				</font> 
			 </td>  
