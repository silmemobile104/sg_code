       ...
       <!-- page content -->
        	<div class="right_col" role="main" style="background-color: #F5F5F7; " >
			  ...
			  <div style="margin-top: 1px;" > 
				 <font size="4px" color="#000000">  กำหนดสิทธิ์การเข้าถึงระบบ ข้อมูลทนาย   </font>  
				 <br> 
				 <font size="2px" color="#000000">  หน้าเเรก > กำหนดสิทธิ์การเข้าถึงระบบ ข้อมูลทนาย  > เพิ่มข้อมูล   </font>   
				 <div > &nbsp; </div>
			  </div> 
			  </font> 
			  </div>
                     ...
                     <font size="4px" color="#000000">  กำหนดสิทธิ์การเข้าถึงระบบ ข้อมูลทนาย  </font>   
                      ...
                      <?php if(empty($_GET["page"])){ ?>
                       ...
                       <div class="col-lg-12">
                      	...
                      	<form role="form" name="frmMain" method="post" action="save_stafftanai.php" enctype="multipart/form-data" onsubmit="return validateForm()"  > 
                       ...
                       <div class="col-lg-5" style="     "> 
                      	  ...
                      	  <div class="col-md-12"  >
							<div class="form-group">
							   <font color = '#000' size="3px" > เลขผู้เสียภาษี </font>   
							  <input type="text" class="form-control" id="pasy" name="pasy"  autocomplete="off" required    style="border-radius: 5px; border: 1px solid #C9C9C9; "   value="<?php echo $pasy; ?>"   maxlength="10"   onkeypress="return (event.charCode !=8 && event.charCode ==0 || ( event.charCode == 46 || (event.charCode >= 48 && event.charCode <= 57)))"   >
							</div> 
						  </div> 
                         ...
                         <div class="col-md-6"   >	
							<div class="form-group">
							   <font color = '#000' size="3px" > ชื่อสถานะประกอบการณ์ </font>   
							  <input type="text" class="form-control" id="nameconatct" name="nameconatct"  autocomplete="off" required    style="border-radius: 5px; border: 1px solid #C9C9C9; "    value="<?php echo $nameconatct; ?>"   >
							</div>
						  </div> 
                         ...
                         <div class="col-md-6"  >	
							<div class="form-group">
							   ...
							   <div class="input-group   "  style="border: 1px solid #C9C9C9; border-radius: 4px; height: 40px; ">  
							    ...
							    <?php 
								$sql = "SELECT * FROM drop_type_staff where pk = '8' order by pk asc  "; 
