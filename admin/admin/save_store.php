...
include("../database.php");
	 ...
	 if(empty($_SESSION["UserID"])){
		...
		$strSQL = "INSERT INTO store ( name, address, telphone, date_start, date_start2, date_time, create_by, major, bank, passport ) 
		VALUES ( 
		'".$_POST["name"]."', '".$_POST["address"]."', '".$_POST["telphone"]."', '".date('d-m-Y')."', '".date('Y-m-d')."', 
		'".date('H:i')."', '".$_SESSION["UserID"]."', '".$_POST["major"]."', '".$_POST["bank"]."', '".$_POST["passport"]."' 
		)"; 
