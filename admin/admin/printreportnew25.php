...
<title>  สรุปรายงานยอดปิดคดี  </title>
</head>  
<style>
@font-face {
  ...
  <style>
	...
	if(!empty($_GET["customername"])){
	 ...
	 ?>            
		...
		<td ><div align="center"><font size="3px" color="Black" style=" font-size: 13px; " > <?php echo DateThai($startdate)." ".DateThai2($startdate); ?>  </font></div></td>
		<td ><div align="center"><font size="3px" color="Black" style=" font-size: 13px; " > <?php echo DateThai($endate)." ".DateThai2($endate); ?>  </font></div></td>
		...
		<td ><div align="center"><font size="3px" color="Black" style=" font-size: 13px; " > <?php echo $n_addon_price; ?>  </font></div></td>				
     
		</tr> 
		<?php $i++; $totaldata1++; $totaldata2 += $n_addon_price;  } ?>
		</tbody>
		...
		<tfooter> 
		 <tr>
			...
			<th width="2%" bgcolor="#FFF" colspan="6" height="35px;"  ><div align="right"> 
