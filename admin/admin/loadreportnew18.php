...
?>
	...
	<thead>  
	 <tr>
		...
		<font size="3px" class="serif2" color="#000" style=" font-size: 15px; "> ยอดหนี้เสีย NPL ตามสัญญา  </font></div></th>       
		<th width="3%" bgcolor="#E2E7EC" style="border: 0px solid #FFF;  border-right: 1px solid #FFF;  "><div align="center"> 
		<font size="3px" class="serif2" color="#000" style=" font-size: 15px; "> ยอดหนี้เสียขาดทุนตามจริง  </font></div></th>   
	 </tr>
	</thead>							
	...
	<?php  
	   ...
	   for($x = 1; $x <= 12; $x++){
		...
		$addcode_re = "  and  a.create_date2 BETWEEN '".$contactstart."' AND '".$checkend."'  "; 
		...
		Inner Join customer b On   a.customer = b.pk
		Inner Join product c On   c.pk = a.menu_id
		where a.bill_no != ''   and a.onoff = 'NPL' and a.closebill = 'เป็นหนี้'  and a.contactstatus = 'อนุมัติแล้ว' 
		".$addcode_re."  
		order by a.pk asc   ";   
		...
		{         
			...
			$totaldata1 += $daytotal*$dayprice;	
			$totaldata2 += $discoount;	
		   ...
		   $loopdataall += $totaldata1-$totaldata2;
	?>
	 <tr>
