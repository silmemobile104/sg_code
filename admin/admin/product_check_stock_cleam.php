...
include('header.php');
	...
	if( ($_GET["all"]) == "1" ){
		...
		$sql_cc = "SELECT * FROM list_order_cleam where w_status_save = 'รอตรวจสอบ' and w_typedata = 'เครมสินค้า' 
		...
		{ 
			...
			$bill_no = $objResult_cc["pk"];
			$status = "เครมสินค้า/รอสินค้า"; 
		   
						  
			$menu_id = "";
			$check_status = "";
			$sql2 = "SELECT * FROM list_order_cleam where pk = '".$objResult_cc["pk"]."'  ";
			...
			$strSQL = " Update list_order_cleam Set               
						...
						w_date2 = '".date('Y-m-d')."' ,
						w_time = '".date('H:i')."'   " ;
			$strSQL .=" WHERE  pk = '".$objResult_cc["pk"]."' "; 
			...
			' ทำรายการจากประวัติเปลี่ยนเครื่อง ".$status."  ', '".$bill_no."', '".$bill_no."' )"; 
			$objQuery = mysqli_query($objCon, $strSQL);
		...
		echo("<script>window.location = 'product_check_stock_cleam.php?searchname2=".$searchname2."';</script>");
	}
                     ...
                     <font size="4px" color="#000000">  ตรวจสอบรายการสินค้า   </font>   
                      ...
                      <?php if(empty($_GET["page"])){ ?>
                    	    ...
                    	    <div   class="col-lg-3"  align="left"  > 
								<table width="100%">
									<tr> 
										...
										<form action="product_check_stock_cleam.php" method="get" >
                           ...
                           <div class="col-md-12"> &nbsp; </div>
							...
							$sql2 = "SELECT a.*, b.name FROM list_order_cleam  a
							Inner Join customer b On   a.customer = b.pk
							where a.bill_no != ''    
							and a.w_status_save = 'รอตรวจสอบ' 
								and a.w_status_save = 'รอตรวจสอบ'  and a.w_typedata = 'เครมสินค้า'
							...
							<?php if (ceil($total_record / $perpage) > 0): ?>
								 <ul class="pagination">
																<?php if ($page > 1): ?>
																<li class="prev"><a href="product_check_stock_cleam.php?page2=<?php echo $page-1 ?>&searchcustomer=<?php echo $searchname; ?>&searchname2=<?php echo $searchname2; ?>&typedata=<?php echo $typedata; ?>">Prev</a></li>
																<?php endif; ?>

																<?php if ($page > 3): ?>
																<li class="start"><a href="product_check_stock_cleam.php?page2=1&searchcustomer=<?php echo $searchname; ?>&searchname2=<?php echo $searchname2; ?>&typedata=<?php echo $typedata; ?>">1</a></li>
																<li class="dots">...</li>
																<?php endif; ?>

																<?php if ($page-2 > 0): ?><li class="page"><a href="product_check_stock_cleam.php?page2=<?php echo $page-2 ?>&searchcustomer=<?php echo $searchname; ?>&searchname2=<?php echo $searchname2; ?>&typedata=<?php echo $typedata; ?>"><?php echo $page-2 ?></a></li><?php endif; ?>
																<?php if ($page-1 > 0): ?><li class="page"><a href="product_check_stock_cleam.php?page2=<?php echo $page-1 ?>&searchcustomer=<?php echo $searchname; ?>&searchname2=<?php echo $searchname2; ?>&typedata=<?php echo $typedata; ?>"><?php echo $page-1 ?></a></li><?php endif; ?>

																<li class="currentpage"><a href="product_check_stock_cleam.php?page2=<?php echo $page ?>&searchcustomer=<?php echo $searchname; ?>&searchname2=<?php echo $searchname2; ?>&typedata=<?php echo $typedata; ?>"><?php echo $page ?></a></li>

																<?php if ($page+1 < ceil($total_record / $perpage)+1): ?><li class="page"><a href="product_check_stock_cleam.php?page2=<?php echo $page+1 ?>&searchcustomer=<?php echo $searchname; ?>&searchname2=<?php echo $searchname2; ?>&typedata=<?php echo $typedata; ?>"><?php echo $page+1 ?></a></li><?php endif; ?>
																<?php if ($page+2 < ceil($total_record / $perpage)+1): ?><li class="page"><a href="product_check_stock_cleam.php?page2=<?php echo $page+2 ?>&searchcustomer=<?php echo $searchname; ?>&searchname2=<?php echo $searchname2; ?>&typedata=<?php echo $typedata; ?>"><?php echo $page+2 ?></a></li><?php endif; ?>

																<?php if ($page < ceil($total_record / $perpage)-2): ?>
																<li class="dots">...</li>
																<li class="end"><a href="product_check_stock_cleam.php?page2=<?php echo ceil($total_record / $perpage) ?>&searchcustomer=<?php echo $searchname; ?>&searchname2=<?php echo $searchname2; ?>&typedata=<?php echo $typedata; ?>"><?php echo ceil($total_record / $perpage) ?></a></li>
																<?php endif; ?>

																<?php if ($page < ceil($total_record / $perpage)): ?>
																<li class="next"><a href="product_check_stock_cleam.php?page2=<?php echo $page+1 ?>&searchcustomer=<?php echo $searchname; ?>&searchname2=<?php echo $searchname2; ?>&typedata=<?php echo $typedata; ?>">Next</a></li>
																<?php endif; ?>
															</ul>
							<?php endif; ?>
							...
							<div class="modal-dialog modal-md" role="document">
								...
								<div class="col-lg-12" align="center">
                            		...
                            		<a href="product_check_stock_cleam.php?all=1&searchname2=<?php echo $searchname2; ?>"    > 
							...
							<div class="modal-dialog modal-md" role="document">
								...
								<div class="col-lg-12" align="center">
									...
									<a href="product_check_stock_cleam.php?all=2&searchname2=<?php echo $searchname2; ?>"    > 
									<button type="button" class="btn btn-primary" style="background-color: #56BFB4; border-radius: 5px; width: 130px; height: 40px; border-color: #56BFB4;  margin-top: 15px; " > <font color="#000000" size="2px" class="serif1" > <b>  ตกลง   </b> </font> </button> 
									</a>
							...
							function  Savenote<?php echo $objResult2["pk"]; ?>( ) { 
								...
								$.ajax({
								type: "POST",
								url: "save_cancel_bill_back_tostore2_note.php?note="+save_key+"&bill_no="+savebill_no,
							...
							function  Canceldata<?php echo $objResult2["pk"]; ?>( ) { 
								...
								$.ajax({
								type: "POST",
								url: "save_cancel_bill_back_tostore2.php?status="+check_status_save+"&bill_no="+save_key,
								contentType: 'application/json',
								data: jsonString,
								success: function(result) {
								//alert(result);
