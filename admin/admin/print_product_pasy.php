...
<?php
	...
	{  
		...
		$name_typedata = "";
		$name_typedataaddress = "";
		$name_typedatatelphone = "";
		$sql = "SELECT * FROM store where pk = '".$objResult2["typedata_2"]."'   order by pk asc  "; 
		$query = mysqli_query($objCon,$sql);
		while($objResult = mysqli_fetch_array($query))
		{ 
			$name_typedata =  $objResult["name"];
			$name_typedataaddress =  $objResult["address"];
			$name_typedatatelphone =  $objResult["telphone"];
		}
		$name_typedata2 = "";
			 ...
			 <table width="100%" border="0"     >  
			  <tr> 
				 ...
				 <div style="margin-left: 0px; margin-right: 0px; margin-top: 2px; " align="left"  >  
					<font size="2px" style="font-size: 15px;">   
					  <?php echo $name_typedata; ?>
					  <div>  </div>
					  <?php echo $name_typedataaddress; ?>
					  <div>  </div>
					</font>
				 </div>
				 </td> 
	...
	<td width="4%"   ><div align="center"> 
	<font size="3px" class="serif2" color="#000" style=" font-size: 13px; ">    เลขทีรายการสั่งซื้อ  </font></div></td>   
	<td width="4%"   ><div align="center"> 
	<font size="3px" class="serif2" color="#000" style=" font-size: 13px; ">  วันทีออกบิล    </font></div></td>  
	<td width="4%"   ><div align="center"> 
	<font size="3px" class="serif2" color="#000" style=" font-size: 13px; ">   ประเภท     </font></div></td>  
	<td width="4%"   ><div align="center"> 
	<font size="3px" class="serif2" color="#000" style=" font-size: 13px; ">   รายการสั่งซื้อ   </font></div></td> 
	<td width="4%"   ><div align="center"> 
	...
	where  bill_no != ''  and  pasy_bill = '". $pasy_bill ."'  Group By bill_no order by pk asc   ";   
	...
	while($objResult2 = mysqli_fetch_array($query2))
	{
		...
		$pasy_name = $objResult2["name"];
		$pasy_createdate = $objResult2["pasy_createdate"];
		$pasy_createtime = $objResult2["pasy_createtime"];
		$pasy_bill = $objResult2["pasy_bill"];
		$pasy_createby = $objResult2["pasy_createby"];
		$total_price_old = $objResult2["price2"]; 
	...
	while($objResult2 = mysqli_fetch_array($query2))
	{
		...
		?>  
		 ...
		 <div align="center" style=" margin-bottom: 5px; "><font size="3px" color="Black" style=" font-size: 13px; " > <?php echo $newbill; ?>  </font></div>  
	...
	while($objResult2 = mysqli_fetch_array($query2))
	{
		...
		?>  
		 ...
		 <div align="center" style=" margin-bottom: 5px; "><font size="3px" color="Black" style=" font-size: 13px; " > <?php echo $name_typedata2; ?>  </font></div>  
	...
	while($objResult2 = mysqli_fetch_array($query2))
	{
		...
		?>  
		 ...
		 <div align="center" style=" margin-bottom: 5px; "><font size="3px" color="Black" style=" font-size: 13px; " > <?php echo $pasy_name; ?>  </font></div>  
	...
	while($objResult2 = mysqli_fetch_array($query2))
	{
		...
		?>  
		 ...
		 <div align="center" style=" margin-bottom: 5px; "><font size="3px" color="Black" style=" font-size: 13px; " > <?php echo number_format(0+$total_price_old); ?>  </font></div>  
