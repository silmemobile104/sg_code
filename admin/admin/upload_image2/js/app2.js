$(function() {
    ...
    $('body').on('change', '.picupload2', function(event) {
        ...
        if (getAttr == 'type1') {
            ...
            $('#media-list2').html('<li class="myupload2"><span><i class="fa fa-plus" aria-hidden="true"></i><input type="file" click-type="type2" id="picupload2" class="picupload2" multiple></span></li>');
