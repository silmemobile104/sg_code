...
$strExcelFileName = "รอชำระNPL.xls";
...
?>
  ...
  <style>
	...
	<?php 
	 ...
	 <thead> 
		   <tr>
				<th width="4%" colspan="10" bgcolor="#FFF" height="35px;" style="border: 0px solid #FFF; border-right: 1px solid #FFF;  border-top-left-radius: 10px;  "  ><div align="center"> 
				<font size="3px" class="serif2" color="#000" style=" font-size: 13px; ">    &nbsp;    </font></div></th>    
				<th width="4%" bgcolor="#FFF" style="border: 1px solid #FFF;  border-right: 1px solid #FFF;  border-top-left-radius: 10px; border-bottom-color: #FFF;  "><div align="center"> 
				<font size="3px" class="serif2" color="#000" style=" font-size: 13px; " id="datashow1"    >   
				<?php echo number_format(0+$total_price); ?>
				</font></div></th>   
				<th width="4%" bgcolor="#FFF" style="border: 1px solid #FFF;  border-right: 1px solid #FFF;      border-bottom-color: #FFF;  "><div align="center"> 
				...
				<th width="4%" bgcolor="#FFF" style="border: 1px solid #FFF;   border-top-right-radius: 10px;  border-bottom-color: #FFF; "><div align="center"> 
				<font size="3px" class="serif2" color="#000" style=" font-size: 13px; " id="datashow6"    >    
					<?php echo number_format(0+$total_price6); ?>   </font></div></th>  
		   </tr>
		   <tr>
			<th width="7%" bgcolor="#FFF" height="35px;" style="border: 0px solid #FFF; border-right: 1px solid #FFF;  border-top-left-radius: 10px;  "  ><div align="center"> 
			...
			<th width="12%" bgcolor="#FFF" style="border: 0px solid #FFF;  border-right: 1px solid #FFF; "><div align="center"> 
			...
			<th width="5%" bgcolor="#FFF" style="border: 0px solid #FFF;  border-right: 1px solid #FFF; border-top-color: #FFF;   "><div align="center"> 
			...
			<font size="3px" class="serif2" color="#000" style=" font-size: 13px; ">  เวลา     </font></div></th>   
								<th width="3%" bgcolor="#FFF" style="border: 0px solid #FFF;   border-top-right-radius: 10px;"><div align="center"> 
	...
	?> 
	   ...
	   <tr id="hddata<?php echo $i; ?>"  style="background-color: <?php echo $bg ?>; "> 
		  ...
		  <td style=" border-left: 0px solid #F2F2F2; "><div align="center"><font size="3px" color="Black" style=" font-size: 12px; " > 
			...
			?> 
			 <?php 
			$sql_pay = "SELECT * FROM droppayment where pk = '".$objResult["typesave"]."' order by pk asc  "; 
			$query_pay = mysqli_query($objCon,$sql_pay);
			while($objResult_pay = mysqli_fetch_array($query_pay))
			{  
			 echo $objResult_pay["name"];  
			}
			?>        
		</font></div></td> 
		...
		<td style=" border-left: 0px solid #F2F2F2; "><div align="center"><font size="3px" color="Black" style=" font-size: 12px; " > 
			...
			$bgdroptxt = "#000"; 
			?> 
			<?php if(empty($objResult["banksave"])){  }else{   
			...
			{ 
			 ...
			 echo $namebank." [เลขบัญชี : ".$objResult_pay["bookbank"]." ]";   
			}
			}
			?>          
		</font></div></td>
