...
?>
  ...
  <style>
	...
	$sql2 = " SELECT * FROM list_chk_cleam_back_two where  bill_no = '".$bill_no."' Group By bill_no  order by pk asc   ";
	...
	while($objResult2 = mysqli_fetch_array($query2))
	{
		...
		$notecleamback = $objResult2["notecleamback"];
		  ...
		  <tr>
			 ...
			 <div style="margin-left: 5px; margin-right: 5px; margin-top: 5px; "  >  
				<font size="2px" style="font-size: 16px;">    
			 	  ...
			 	  เลขที่เอกสาร <?php echo $bill_no; ?>  <br>    
				</font>
			 </div>
			 </td>
...
$sql2 = " SELECT * FROM list_chk_cleam_back_two where  bill_no = '".$bill_no."'  order by pk asc  ";   
    ...
    <br>  
 	...
 	<table width="100%" border="0"   >  
		  ...
		  <tr> 
			 ...
			 <div style="margin-left: 5px; margin-right: 5px; margin-top: 5px; "  >  
				<font size="2px" style="font-size: 16px;">    
			 	  เงื่อนไขการส่งสินค้า : <?php echo   $notecleamback ; ?>        <br> 
				</font>
			 </div>
			 </td> 
		  </tr>   
