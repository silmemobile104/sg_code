...
?>
	...
	<thead>  
	 <tr>
		...
		<font size="3px" class="serif2" color="#000" style=" font-size: 15px; "> มูลค่าสินค้าเข้าสต๊อก  </font></div></th>       
		<th width="3%" bgcolor="#E2E7EC" style="border: 0px solid #FFF;  border-right: 1px solid #FFF;  "><div align="center"> 
		<font size="3px" class="serif2" color="#000" style=" font-size: 15px; "> มูลค่าสินค้าที่จำหน่ายแล้ว  </font></div></th>             
		<th width="3%" bgcolor="#E2E7EC" style="border: 0px solid #FFF; "><div align="center"> 
		<font size="3px" class="serif2" color="#000" style=" font-size: 15px; ">   สิ้นค้าคงเหลือทั้งสิ้น   </font></div></th>  
	 </tr>
	</thead>							
	...
	<?php  
	   ...
	   for($x = 1; $x <= 12; $x++){
		...
		$addcode_re = "  and  create_date2 BETWEEN '".$contactstart."' AND '".$checkend."'  "; 
		...
		$sql2 = " SELECT * FROM product  where name != ''    ".$addcode."   order by pk asc   ";   
		...
		{        
			if(empty($objResult2["price1"])){ 
				...
				$totaldata1 += $objResult2["price1"];
			} 
				
		}
		   
	    $sql2 = " SELECT * FROM list_order  where bill_no != ''   and  contactstatus = 'อนุมัติแล้ว'   ".$addcode_re."   order by pk asc   ";   
		$query2 = mysqli_query($con,$sql2); 
		while($objResult2 = mysqli_fetch_array($query2))
		{        
			if(empty($objResult2["money"])){ 
				...
				$totaldata2 += $objResult2["money"];
			} 
				
		}
		   
		   $totaldata3 = $totaldata1 - $totaldata2;
		   
		   if($totaldata3 <= 0){
			   $totaldata3 = 0;
		   }
		   $loopdataall += $totaldata3;
	?>
	 <tr>
	 ...
	 <?php $loopdataall1 += $totaldata1; $loopdataall2 += $totaldata2;     } ?>
	...
	<tfooter> 
	 <tr>
		...
		<th width="2%" bgcolor="#FFF" colspan="1" height="35px;" style="border: 1px solid #DCDCDC;  "  ><div align="center"> 
		<font size="3px" class="serif2" color="#FF0000" style=" font-size: 15px; ">  <?php echo number_format(0+$loopdataall); ?>  &nbsp;  </font></div></th>    
	 </tr>
