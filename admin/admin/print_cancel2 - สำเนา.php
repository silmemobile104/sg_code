...
?>
  ...
  <style>
	...
	$sql = "SELECT * FROM major Where  pk = '". $major ."' ";   
	$query = mysqli_query($objCon,$sql); 
	while($objResult = mysqli_fetch_array($query))
	{  
		  ...
		  <tr>
			 ...
			 <div style="margin-left: 5px; margin-right: 5px; margin-top: 5px; " align="left"  >  
				...
				<font size="2px" style="font-size: 17px;">   
			 	  <?php echo $names; ?>   <br>  
			 	  <?php echo $addresss; ?>  โทร <?php echo $telphones; ?>   <br>   
				</font>
				</font>
			 </div>
			 </td> 
			 ...
			 <td align="left" width="100%" valign="top"  >   
				<font size="2px" style="font-size: 16px;">   
				 ...
				 วันทีเริ่มทำสัญญา <?php echo DateThai($startdate)." ".DateThai2($startdate); ?>  ถึงวันที่ <?php echo DateThai($endate)." ".DateThai2($endate); ?> 
		 	 	 ...
		 	 	 <div style="margin-top: 5px; ">  </div>  
					ราคาทุน <?php echo number_format(0+$priceorder); ?> เงินดาวน์ <?php echo number_format(0+$moneydown); ?> จ่ายค่างวด <?php echo number_format(0+$priceback); ?>    ยอดคงเหลือ <?php echo number_format(0+$pricetotal2); ?>
		 	 	 <div style="margin-top: 5px; ">  </div>   
					ยอดค่าปรับสะสม <?php echo number_format(0+$chk_total*50); ?> รวม <?php echo number_format(0+$pricetotal3); ?> 
	 	 	 		ส่วนลด <?php echo number_format(0+$discount); ?>  ยอดสุทธิ์ <?php echo number_format(0+$pricetotal3-$discount); ?> 
		 	 	 <div style="margin-top: 5px; ">  </div>  
			 ...
			 <td align="left" width="100%" valign="top"  >   
				<font size="2px" style="font-size: 16px;">   
				 ...
				 จำนวนงวด <?php echo  number_format(0+$daytotal); ?>  งวด
		 	 	 <div style="margin-top: 5px; ">  </div> 
				 ยอดดำเนินคดี <?php echo  number_format(0+$n_addon_price); ?>   
		 	 	 <div style="margin-top: 5px; ">  </div> 
				 เงินดาวน์ <?php echo  number_format(0+$moneydown); ?> ยอดผ่อนชำระ <?php echo  number_format(0+$discoount); ?> ยอดรวม <?php echo  number_format(0+$endback); ?> คืนให้ลูกค้า <?php echo  number_format(0+$c_price_back); ?> 
		 	 	 <div style="margin-top: 5px; ">  </div> 
					หมายเหตุ <?php echo $note; ?>
		 	 	 </div> 
				</font> 
