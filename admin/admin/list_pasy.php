       ...
       <!-- page content -->
        	<div class="right_col" role="main" style="background-color: #F5F5F7; " >
             ...
             <div style="margin-top: 1px;" > 
                     <font size="4px" color="#000000">  หนังสือรับรองการหักภาษี    </font>  
                     <br> 
                     <font size="2px" color="#000000">  หน้าเเรก > หนังสือรับรองการหักภาษี     </font>   
                     <div > &nbsp; </div>
             </div> 
             </font> 
             </div>
                     ...
                     <font size="4px" color="#000000">  หนังสือรับรองการหักภาษี   </font>   
                      ...
                      <?php if(empty($_GET["page"])){ ?>
                        ...
                        <div class="col-md-8" style="margin-top: 15px;" align="right" >  
						 ...
						 <a href="list_pasy_all.php?page2=<?php echo $page-1 ?>&searchname=<?php echo $searchname; ?>&searchname2=<?php echo $searchname2; ?>&searchname3=<?php echo $searchname3; ?>&searchname4=<?php echo $searchname4; ?>&searchname4=<?php echo $searchname4; ?>"> 
						 ...
						 <a href="list_pasy_cancel.php?page2=<?php echo $page-1 ?>&searchname=<?php echo $searchname; ?>&searchname2=<?php echo $searchname2; ?>&searchname3=<?php echo $searchname3; ?>&searchname4=<?php echo $searchname4; ?>&searchname4=<?php echo $searchname4; ?>"> 
						 ...
						 <a href="list_pasy.php?page=1&searchname=<?php echo $searchname; ?>&searchname2=<?php echo $searchname2; ?>&searchname3=<?php echo $searchname3; ?>&searchname4=<?php echo $searchname4; ?>&searchname4=<?php echo $searchname4; ?>"> 
						...
						?>       
                          ...
                          <div class="col-lg-12">
							...
							<div class="col-md-8" style="margin-top: 15px;" align="right" >  
							 ...
							 <a href="list_pasy.php?page2=<?php echo $page-1 ?>&searchname=<?php echo $searchname; ?>&searchname2=<?php echo $searchname2; ?>&searchname3=<?php echo $searchname3; ?>&searchname4=<?php echo $searchname4; ?>&searchname4=<?php echo $searchname4; ?>"> 
							...
							<script>  
							 ...
							 function loadpasyold() 
							 {
								...
								$.ajax({
								type: "GET",
								url: "loadtotalbill_pasy_cal.php?bill_old=",
								success: function(result) {
						...
						<?php 
							...
							<div align="center"><font size="3px" color="Black" style=" font-size: 13px; " > 
								...
								function getRadioVaal(radio_val){ 
									 ...
									 $.ajax({
										type: "POST",
										url: "save_select_pasy_cancel.php",
										data: {data1:int1, data2:int2, data3:int3, bill_save:bill_save},
										success: function(result) {
						...
						<font size="3px" class="serif2" color="#000" style=" font-size: 13px; ">  ยอดเงินส่งคืน   </font></div></th>  
						 ...
						 <tfoot>  
                      	    ...
                      	    <form role="form" name="frmMain" method="post" action="save_confrim_list_pasy.php" enctype="multipart/form-data" onsubmit="return validateForm()"  > 
						...
						?>       
                          ...
                          <div class="col-lg-12">
						   ...
						   <div   class="col-lg-4"  align="left"   > 
							...
							<ul class="pagination">
							<?php if ($page > 1): ?>
							<li class="prev"><a href="list_pasy.php?page2=<?php echo $page-1 ?>&searchcustomer=<?php echo $searchname; ?>&searchname2=<?php echo $searchname2; ?>&searchname3=<?php echo $searchname3; ?>&searchname4=<?php echo $searchname4; ?>&searchname5=<?php echo $searchname5; ?>&alldata=<?php echo $alldata; ?>&month=<?php echo $month; ?>&year=<?php echo $year; ?>&searchtype=<?php echo $searchtype; ?>&page=2">Prev</a></li>
							<?php endif; ?>

							<?php if ($page > 3): ?>
							<li class="start"><a href="list_pasy.php?page2=1&searchcustomer=<?php echo $searchname; ?>&searchname2=<?php echo $searchname2; ?>&searchname3=<?php echo $searchname3; ?>&searchname4=<?php echo $searchname4; ?>&searchname5=<?php echo $searchname5; ?>&alldata=<?php echo $alldata; ?>&month=<?php echo $month; ?>&year=<?php echo $year; ?>&searchtype=<?php echo $searchtype; ?>&page=2">1</a></li>
							<li class="dots">...</li>
							<?php endif; ?>

							<?php if ($page-2 > 0): ?><li class="page"><a href="list_pasy.php?page2=<?php echo $page-2 ?>&searchcustomer=<?php echo $searchname; ?>&searchname2=<?php echo $searchname2; ?>&searchname3=<?php echo $searchname3; ?>&searchname4=<?php echo $searchname4; ?>&searchname5=<?php echo $searchname5; ?>&alldata=<?php echo $alldata; ?>&month=<?php echo $month; ?>&year=<?php echo $year; ?>&searchtype=<?php echo $searchtype; ?>&page=2"><?php echo $page-2 ?></a></li><?php endif; ?>
							<?php if ($page-1 > 0): ?><li class="page"><a href="list_pasy.php?page2=<?php echo $page-1 ?>&searchcustomer=<?php echo $searchname; ?>&searchname2=<?php echo $searchname2; ?>&searchname3=<?php echo $searchname3; ?>&searchname4=<?php echo $searchname4; ?>&searchname5=<?php echo $searchname5; ?>&alldata=<?php echo $alldata; ?>&month=<?php echo $month; ?>&year=<?php echo $year; ?>&searchtype=<?php echo $searchtype; ?>&page=2"><?php echo $page-1 ?></a></li><?php endif; ?>

							<li class="currentpage"><a href="list_pasy.php?page2=<?php echo $page ?>&searchcustomer=<?php echo $searchname; ?>&searchname2=<?php echo $searchname2; ?>&searchname3=<?php echo $searchname3; ?>&searchname4=<?php echo $searchname4; ?>&searchname5=<?php echo $searchname5; ?>&alldata=<?php echo $alldata; ?>&month=<?php echo $month; ?>&year=<?php echo $year; ?>&searchtype=<?php echo $searchtype; ?>&page=2"><?php echo $page ?></a></li>

							<?php if ($page+1 < ceil($total_record / $perpage)+1): ?><li class="page"><a href="list_pasy.php?page2=<?php echo $page+1 ?>&searchcustomer=<?php echo $searchname; ?>&searchname2=<?php echo $searchname2; ?>&searchname3=<?php echo $searchname3; ?>&searchname4=<?php echo $searchname4; ?>&searchname5=<?php echo $searchname5; ?>&alldata=<?php echo $alldata; ?>&month=<?php echo $month; ?>&year=<?php echo $year; ?>&searchtype=<?php echo $searchtype; ?>&page=2"><?php echo $page+1 ?></a></li><?php endif; ?>
							<?php if ($page+2 < ceil($total_record / $perpage)+1): ?><li class="page"><a href="list_pasy.php?page2=<?php echo $page+2 ?>&searchcustomer=<?php echo $searchname; ?>&searchname2=<?php echo $searchname2; ?>&searchname3=<?php echo $searchname3; ?>&searchname4=<?php echo $searchname4; ?>&searchname5=<?php echo $searchname5; ?>&alldata=<?php echo $alldata; ?>&month=<?php echo $month; ?>&year=<?php echo $year; ?>&searchtype=<?php echo $searchtype; ?>&page=2"><?php echo $page+2 ?></a></li><?php endif; ?>

							<?php if ($page < ceil($total_record / $perpage)-2): ?>
							<li class="dots">...</li>
							<li class="end"><a href="list_pasy.php?page2=<?php echo ceil($total_record / $perpage) ?>&searchcustomer=<?php echo $searchname; ?>&searchname2=<?php echo $searchname2; ?>&searchname3=<?php echo $searchname3; ?>&searchname4=<?php echo $searchname4; ?>&searchname5=<?php echo $searchname5; ?>&alldata=<?php echo $alldata; ?>&month=<?php echo $month; ?>&year=<?php echo $year; ?>&searchtype=<?php echo $searchtype; ?>&page=2"><?php echo ceil($total_record / $perpage) ?></a></li>
							<?php endif; ?>

							<?php if ($page < ceil($total_record / $perpage)): ?>
							<li class="next"><a href="list_pasy.php?page2=<?php echo $page+1 ?>&searchcustomer=<?php echo $searchname; ?>&searchname2=<?php echo $searchname2; ?>&searchname3=<?php echo $searchname3; ?>&searchname4=<?php echo $searchname4; ?>&searchname5=<?php echo $searchname5; ?>&alldata=<?php echo $alldata; ?>&month=<?php echo $month; ?>&year=<?php echo $year; ?>&searchtype=<?php echo $searchtype; ?>&page=2">Next</a></li>
							<?php endif; ?>
							</ul>
							<?php endif; ?>
						  </div>  
						   ...
						   <table id="key_product"  class=" table    tablemobile  " border="0"   >
							...
							while($objResult2 = mysqli_fetch_array($query2))
							{
								...
								$no = 0;
								$sql_c = " SELECT *  FROM list_chk_computer where  bill_no != ''  and pasy_bill != ''
								 and pasy_bill = '".$pasy_bill."'
							...
							<a href="print_list_pasy.php?pasy_bill=<?php echo $objResult2["pasy_bill"]; ?>" target="_blank" class="  btn-sm " style="background-color: #FFF; border-radius: 5px;  border-color: #F77369; border: 1px solid  #F77369;   " >
							...
							<a href="list_pasy.php?pasy_bill=<?php echo $objResult2["pasy_bill"]; ?>&page=3"  class="  btn-sm " style="background-color: #FFF; border-radius: 5px;  border-color: #F77369; border: 1px solid  #F77369;   " >
							<font size="3px" color="#F77369" style=" font-size: 13px; " > 
							คลิก   
							</font>  
							</a> 
							...
							<th width="3%" bgcolor="#BEC6CB" style="border: 0px solid #FFF;  border-right: 1px solid #FFF;  "><div align="center"> 
							<font size="3px" class="serif2" color="#000" style=" font-size: 13px; ">  ยอดเงินค่าคอม     </font></div></th>  
							<th width="3%" bgcolor="#BEC6CB" style="border: 0px solid #FFF;  border-right: 1px solid #FFF;  "><div align="center"> 
