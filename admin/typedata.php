        	...
        	<div class="right_col" role="main" style="background-color: #F5F5F7; " >
             ...
             <div class=" col-lg-12 " style="  " align="left" >
                  ...
                  <div style="margin-top: 1px;" > 
                     ...
                     <br> 
                     <font size="2px" color="#000000">  หน้าเเรก > เพิ่มประเภทข้อมูลรายการสินค้า > ประเภทสินค้า  </font>   
                     <div > &nbsp; </div>
                  </div> 
                  </font> 
                  </div>
                  ...
                  <div style="margin-top: 6px;" > 
                     <font size="4px" color="#000000">  เพิ่มประเภทข้อมูลรายการสินค้า   </font>   
                      ...
                      <?php if(empty($_GET["page"])){ ?>
                  		     ...
                  		     <form role="form" name="frmMain" method="post" action="save_typedata.php" enctype="multipart/form-data" onsubmit="return validateForm()" > 

							  <div class="col-md-5" style=" margin-top:  15px; " > 

							   <div class="col-md-12 "> 
								  <div class="form-group"> 
									 <font class="serif" size="3px" color="black" for="address"> ประเภทสินค้า  </font>
							...
							<table width="100%">
									<tr>  
										...
										<form action="typedata.php" method="get" >
										<div class="input-group   "  style="border: 1px solid #C9C9C9; border-radius: 4px; height: 40px; "> 
                             ...
                             <div class="col-md-12" style="margin-top: 15px;" > 
								  <style>
											...
											$sql2 = " SELECT * FROM drop_typedata  
											where  name != ''   
											".$addcode.$addcode2."  
											order by  pk asc    "; 
											...
											<?php if (ceil($total_record / $perpage) > 0): ?>
												<ul class="pagination">
																				<?php if ($page > 1): ?>
																				<li class="prev"><a href="typedata.php?page2=<?php echo $page-1 ?>&searchcustomer=<?php echo $searchname; ?>&searchname2=<?php echo $searchname2; ?>">Prev</a></li>
																				<?php endif; ?>

																				<?php if ($page > 3): ?>
																				<li class="start"><a href="typedata.php?page2=1&searchcustomer=<?php echo $searchname; ?>&searchname2=<?php echo $searchname2; ?>">1</a></li>
																				<li class="dots">...</li>
																				<?php endif; ?>

																				<?php if ($page-2 > 0): ?><li class="page"><a href="typedata.php?page2=<?php echo $page-2 ?>&searchcustomer=<?php echo $searchname; ?>&searchname2=<?php echo $searchname2; ?>"><?php echo $page-2 ?></a></li><?php endif; ?>
																				<?php if ($page-1 > 0): ?><li class="page"><a href="typedata.php?page2=<?php echo $page-1 ?>&searchcustomer=<?php echo $searchname; ?>&searchname2=<?php echo $searchname2; ?>"><?php echo $page-1 ?></a></li><?php endif; ?>

																				<li class="currentpage"><a href="typedata.php?page2=<?php echo $page ?>&searchcustomer=<?php echo $searchname; ?>&searchname2=<?php echo $searchname2; ?>"><?php echo $page ?></a></li>

																				<?php if ($page+1 < ceil($total_record / $perpage)+1): ?><li class="page"><a href="typedata.php?page2=<?php echo $page+1 ?>&searchcustomer=<?php echo $searchname; ?>&searchname2=<?php echo $searchname2; ?>"><?php echo $page+1 ?></a></li><?php endif; ?>
																				<?php if ($page+2 < ceil($total_record / $perpage)+1): ?><li class="page"><a href="typedata.php?page2=<?php echo $page+2 ?>&searchcustomer=<?php echo $searchname; ?>&searchname2=<?php echo $searchname2; ?>"><?php echo $page+2 ?></a></li><?php endif; ?>

																				<?php if ($page < ceil($total_record / $perpage)-2): ?>
																				<li class="dots">...</li>
																				<li class="end"><a href="typedata.php?page2=<?php echo ceil($total_record / $perpage) ?>&searchcustomer=<?php echo $searchname; ?>&searchname2=<?php echo $searchname2; ?>"><?php echo ceil($total_record / $perpage) ?></a></li>
																				<?php endif; ?>

																				<?php if ($page < ceil($total_record / $perpage)): ?>
																				<li class="next"><a href="typedata.php?page2=<?php echo $page+1 ?>&searchcustomer=<?php echo $searchname; ?>&searchname2=<?php echo $searchname2; ?>">Next</a></li>
																				<?php endif; ?>
																			</ul>
											<?php endif; ?>
							...
							<table id="key_product"  class=" table    tablemobile  " border="0"    >
							 ...
							 <tr>
								...
								<font size="3px" class="serif2" color="#000" style=" font-size: 13px; ">  แก้ไข   </font></div></th>  
									...
									?>
									<a href="typedata.php?CusID=<?php echo $objResult2["pk"];?>&page=1" class="  btn-sm " style="background-color: #FFF; border-radius: 5px;  border-color: #F77369; border: 1px solid  #F77369;   " >
									...
									<input type="hidden" id="pageget" name="pageget" value="รายการสินค้า">
						...
						if(isset($_GET["page"])){
						if( ($_GET["page"]) == "1" ){
						$sql = "SELECT * FROM drop_typedata Where  pk = '". $_GET["CusID"] ."' ";  
						$query = mysqli_query($objCon,$sql); 
						while($objResult = mysqli_fetch_array($query))
						{  
							$name = $objResult["name"];  
						...
						?> 
                  		     ...
                  		     <form role="form" name="frmMain" method="post" action="save_typedata_update.php" enctype="multipart/form-data" onsubmit="return validateForm()" > 
