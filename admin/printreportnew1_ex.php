...
$strExcelFileName = "รายงานสรุปบัญชีสินเชื่อ.xls";
  ...
  <style>
	...
	if(!empty($_GET["customername"])){
	 ...
	 ?>            
		...
		<td height="35px;" ><div align="center"><font size="3px" color="Black" style=" font-size: 13px; " > <?php echo $objResult2["codecustomer"]; ?>  </font></div></td>
