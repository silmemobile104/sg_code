...
?>
	...
	<thead>  
	 <tr>
		...
		<font size="3px" class="serif2" color="#000" style=" font-size: 15px; "> ยอดรับเงินออม  </font></div></th>       
		<th width="3%" bgcolor="#E2E7EC" style="border: 0px solid #FFF;  border-right: 1px solid #FFF;  "><div align="center"> 
		<font size="3px" class="serif2" color="#000" style=" font-size: 15px; "> ยอดถอนเงินออม  </font></div></th>      
		<th width="3%" bgcolor="#E2E7EC" style="border: 0px solid #FFF;  border-right: 1px solid #FFF;  "><div align="center"> 
	...
	<?php  
	   ...
	   for($x = 1; $x <= $loadyear; $x++){
		...
		{       
			...
			if(!empty($objResult2["price"])){ 
				$totaldata2 += $objResult2["price"];
				
				
				
				$income2 = $objResult2["price"];
   				$totaldata4 += ($percent / 100)   * $income2; 
			}
			}
		   ...
		   $totaldata3 =  $nextprice + $totaldata1  - $totaldata2 + $totaldata4;
		   ...
		   if($totaldata1 == 0){
			   ...
			   if($totaldata2 == 0){
				   ...
				   $totaldata3_nwe =  $nextprice + $totaldata1  - $totaldata2;

				   if($totaldata3_nwe <= 0){
					   $totaldata3_nwe = 0;
				   }
				    
				   $nextprice = $totaldata3_nwe; 
			   }
		   }
	...
	<tfooter> 
	 <tr>
		...
		<font size="3px" class="serif2" color="#000" style=" font-size: 15px; ">  <?php echo number_format(0+$lowtop1); ?>  &nbsp;  </font></div></th> 
		<th width="2%" bgcolor="#FFF" colspan="1" height="35px;" style="border: 1px solid #DCDCDC;  "  ><div align="center"> 
		<font size="3px" class="serif2" color="#000" style=" font-size: 15px; ">  <?php echo number_format(0+$lowtop2); ?>  &nbsp;  </font></div></th> 
		<th width="2%" bgcolor="#FFF" colspan="1" height="35px;" style="border: 1px solid #DCDCDC;  "  ><div align="center"> 
		<font size="3px" class="serif2" color="#000" style=" font-size: 15px; ">  <?php echo number_format(0+$lowtop3); ?>  &nbsp;  </font></div></th>    
	 </tr>
