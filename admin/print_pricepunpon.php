...
?>
  ...
  <style>
	 ...
	 $bill_no = $_GET["bill_no"];
	  ...
	  $namemember5 = "";
    $sql2 = "  SELECT *  FROM pricepunpon   where bill_no = '".$bill_no."'     ";  
...
?>
  	...
  	<table width="100%" border="0"   >  
		  <tr>  
			 ...
			 <div style="margin-left: 5px; margin-right: 5px; margin-top: 5px; "  >  
				<font size="2px" style="font-size: 18px;">     
			 	 	จ่ายให้   <?php echo $c_names;?>  &nbsp; <?php echo $c_telphone;?> <br> 
				</font>
			 </div>
			 </td>
		  </tr>    
...
<td><div align="left" style=" margin-left: 5px; margin-right: 5px; "><font size="3px" color="Black" style=" font-size: 18px; " > <?php echo $notedata; ?> </font></div></td> 
 
<td><div align="center"><font size="3px" color="Black" style=" font-size: 18px; " > <?php echo number_format(0+$percent); ?> </font></div></td>
...
<td colspan="1" >
<div align="center"><font size="3px" color="Black" style=" font-size: 18px; " > <?php echo number_format(0+$percent); ?>  </font></div>
</td>
</tr>  
<tr> 
<td colspan="2" >
