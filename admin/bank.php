        	...
        	<div class="right_col" role="main" style="background-color: #F5F5F7; " >
             ...
             <div class=" col-lg-12 " style="  " align="left" >
                  ...
                  <div style="margin-top: 1px;" > 
                     <font size="4px" color="#000000">  ช่องทางชำระเงิน   </font>  
                     <br> 
                     <font size="2px" color="#000000">  หน้าเเรก > ช่องทางชำระเงิน    </font>   
                     <div > &nbsp; </div>
                  </div> 
                  </font> 
                  </div>
                      ...
                      <?php if(empty($_GET["page"])){ ?>
							  ...
							  <div class="col-md-4" style=" margin-top:  15px; " > 
								...
								<div class="form-group">
								   ...
								   <div class="input-group   "  style="border: 1px solid #C9C9C9; border-radius: 4px; height: 40px; ">  
									<select class="form-control" id="bank" name="bank" required style="width:30px;-webkit-appearance: none; border:  0px solid #FFF; border-radius: 5px;  "  >  
								...
								<div class="form-group">
								   ...
								   <input type="text" class="form-control" id="bookbank" name="bookbank"  autocomplete="off" required    style="border: 1px solid #CACACA; height: 40px;  border-radius: 5px; background-color: #FFF;"  value="<?php echo $bookbank; ?>"   >
								</div>
							  </div> 
							...
							<table id="key_product"  class=" table    tablemobile  " border="0"    >
							 <thead> 
								...
								$sql2 = " SELECT * FROM bank2  where name != ''   ".$addcode.$addcode2."   order by pk asc    limit {$start} , {$perpage}   "; 
								...
								<?php }else{ ?>
									...
									<a href="bank.php?CusID=<?php echo $objResult2["pk"];?>&page=1" class="  btn-sm " style="background-color: #FFF; border-radius: 5px;  border-color: #F77369; border: 1px solid  #F77369; display: none; " id="nextpage<?php echo $objResult2["pk"]; ?>" >
									...
									<input type="hidden" id="pageget" name="pageget" value="ช่องทางชำระเงิน">
