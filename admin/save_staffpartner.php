...
include("../database.php");
	...
	if($objResult)
	{
			 ...
			 echo("<script>window.location = 'staffpartner.php';</script>");
	}
	else
	{	
		...
		$strSQL = "INSERT INTO member_all (
		 ...
		 chk25, chk26, chk27, major, store
		 
		 ) VALUES (
		  '".$_POST["name"]."',  '".$_POST["username"]."', '".$_POST["password"]."', 'P', '".$_POST["address"]."',    
		  ...
		  '".$_POST["data25"]."',  '".$_POST["data26"]."', '".$_POST["data27"]."', '".$_POST["major"]."', '".$_POST["store"]."'
		)"; 
		$objQuery = mysqli_query($objCon, $strSQL);
