...
include('../database.php');
		...
		$obj = json_decode($input); 
			...
			if(empty($member_user)){ 
				...
				$major2_chk = "";
				$strSQL2 = "SELECT * FROM list_chk_computer WHERE pasy_bill = '' and pasy_createby = '".$_SESSION["UserID"]."'   ";
				...
				{ 			
					...
					if($major2_chk != $major2){  
						$strSQL = " Update list_chk_computer Set  pasy_onoff = ''   " ;
					...
					$strSQL = "SELECT * FROM list_chk_computer WHERE bill_no = '".$bill_save."' and pasy_onoff = '' ";
					$objQuery = mysqli_query($objCon, $strSQL);
