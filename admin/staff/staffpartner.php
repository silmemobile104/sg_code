       ...
       <!-- page content -->
        	<div class="right_col" role="main" style="background-color: #F5F5F7; " >
			  ...
			  <div style="margin-top: 1px;" > 
				 <font size="4px" color="#000000">  กำหนดสิทธิ์การเข้าถึงระบบ พาทเนอร์   </font>  
				 <br> 
				 <font size="2px" color="#000000">  หน้าเเรก > กำหนดสิทธิ์การเข้าถึงระบบ พาทเนอร์  > เพิ่มข้อมูล   </font>   
				 <div > &nbsp; </div>
			  </div> 
			  </font> 
			  </div>
                     ...
                     <font size="4px" color="#000000">  กำหนดสิทธิ์การเข้าถึงระบบ พาทเนอร์  </font>   
                      ...
                      <?php if(empty($_GET["page"])){ ?>
                       ...
                       <div class="col-lg-12">
                      	...
                      	<form role="form" name="frmMain" method="post" action="save_staffpartner.php" enctype="multipart/form-data" onsubmit="return validateForm()"  > 
                         ...
                         <div class="col-md-6"  >	
							<div class="form-group">
							   ...
							   <div class="input-group   "  style="border: 1px solid #C9C9C9; border-radius: 4px; height: 40px; ">  
							    ...
							    <?php 
								$sql = "SELECT * FROM drop_type_staff where pk = '7' order by pk asc  "; 
