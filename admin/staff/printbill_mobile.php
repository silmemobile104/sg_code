  ...
  <style>
    ...
    <table width="100%" border="0"   > 
		  ...
		  <tr>
			 ...
			 <div style="margin-left: 5px; margin-right: 5px; margin-top: 5px; "  >  
				<font size="2px" style="font-size: 16px;">   
			 	 ...
			 	 <b> &nbsp; ชื่อผู้ทำสัญญา  </b>  <?php echo $customer;  ?>   <br> 
			 	 <b> &nbsp; ที่อยู่  </b>    <br> 
	 ...
	 <td align="center" width="30%" valign="top" height="70px"  >       
		  ...
		  <tr>
			 ...
			 <div style="margin-left: 5px; margin-right: 5px; margin-top: 5px; "  >  
				<font size="2px" style="font-size: 16px;">   
			 	 <b> &nbsp; วันที่  </b>   <?php echo DateThai($datesave2)." ".DateThai2($datesave2); ?> <br>
			 	 <b> &nbsp; เลขที่ใบเสร็จ  </b>  
			 	   <?php echo $bill_no; ?>
			 	  <br> 
    ...
    <table width="100%" border="0"   > 
		  ...
		  <tr>
			 ...
			 <div style="margin-left: 5px; margin-right: 5px; margin-top: 5px; "  >  
				<font size="2px" style="font-size: 16px;">   
			 	 <b>  รวมเงิน  <?php echo number_format(0+$price2, '2', '.', ','); ?> บาท   </b>  
				</font
			 </div>
			 </td> 
			 ...
			 <div style="margin-left: 5px; margin-right: 5px; margin-top: 5px; "  >  
				<font size="2px" style="font-size: 16px;">   
			 	 <b> รวมเป็นเงิน <?php echo number_format(0+$price2, '2', '.', ','); ?> บาท    </b>  
				</font>
			 </div>
			 </td>  
			 </tr>   
			 ...
			 <div style="margin-left: 5px; margin-right: 5px;   "  >  
				<font size="2px" style="font-size: 16px;">   
			 	 <b> ( 
					...
					if($statusavevat == "ไม่มี Vat"){
						echo ReadNumber(0+$price2 ) ; 
					}else{
						///echo ReadNumber(0+$price2 +   ($price2*0.07)  ) ; 
						echo ReadNumber(0+$price2 ) ; 
					} 
					?> บาท 
			 ...
			 <td align="right" width="30%" valign="top" height="0px"   >  
			  <table width="100%" border="0"     >  
				  <tr>
					 ...
					 <div style="margin-left: 5px; margin-right: 5px; margin-top: 5px; "  >  
						<font size="2px" style="font-size: 16px;">   
						 <b> &nbsp;    <?php echo number_format(0+$price2, '2', '.', ','); ?> </b>  <br>
						 <b> &nbsp;    <?php 
							 
							 if($statusavevat == "ไม่มี Vat"){
								 echo number_format(0, '2', '.', ','); 
							 }else{
								echo number_format(0+($price2*0.07) , '2', '.', ',');  
							 }
						 ...
						 <b> &nbsp;    <?php 
							 ...
							 if($statusavevat == "ไม่มี Vat"){
							 	echo number_format(0+$price2, '2', '.', ','); 
							 }else{
								echo number_format(0+   $price2 +   ($price2*0.07) , '2', '.', ',');  
							 } 
