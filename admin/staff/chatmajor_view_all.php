       ...
       <!-- page content -->
        	<div class="right_col" role="main" style="background-color: #F5F5F7; " >
                  ...
                  <div style="margin-top: 1px;" > 
                     ...
                     <br> 
                     <font size="2px" color="#000000">  หน้าเเรก > ดูรายการบันทึกทุกสาขา   </font>   
                     <div > &nbsp; </div>
                  </div> 
                  </font> 
                  </div>
              ...
              <div class=" col-lg-12 "  style="margin-top: -15px;"  > 
                <div class="x_panel"  style="background-color: #FFFFFF;  border-radius: 10px; " > 
                  ...
                  <div style="margin-top: 6px;" > 
                     <font size="4px" color="#000000">  ดูรายการบันทึกทุกสาขา   </font>   
                  </div> 
                  </font> 
                  </div>
                      ...
                      <?php if(empty($_GET["page"])){ ?>
                     	    ...
                     	    <div   class="col-lg-8"  align="left"  > 
								<table width="100%">
									<tr> 
										...
										<form action="chatmajor_view_all.php" method="get" >
										<div class="input-group   "  style="border: 1px solid #C9C9C9; border-radius: 4px; height: 40px; ">
										 <select class="form-control myselect " id="searchname" name="searchname"   style="background-color: #FAFAFA;  border: 1px solid #C9C9C9;  border: 0px; border-radius: 5px; width: 100%;   "    >  
                   			 ...
                   			 <div class="col-md-12" style="margin-top: 15px;" > 
								  <style>
											...
											where datesave != ''   and drop_chat  = 'อยู่ในระหว่างการติดตาม'
											".$addcode.$addcode2."  
											order by pk asc    "; 
											...
											<?php if (ceil($total_record / $perpage) > 0): ?>
												<ul class="pagination">
																				<?php if ($page > 1): ?>
																				<li class="prev"><a href="chatmajor_view_all.php?page2=<?php echo $page-1 ?>&searchcustomer=<?php echo $searchname; ?>&searchname2=<?php echo $searchname2; ?>">Prev</a></li>
																				<?php endif; ?>

																				<?php if ($page > 3): ?>
																				<li class="start"><a href="chatmajor_view_all.php?page2=1&searchcustomer=<?php echo $searchname; ?>&searchname2=<?php echo $searchname2; ?>">1</a></li>
																				<li class="dots">...</li>
																				<?php endif; ?>

																				<?php if ($page-2 > 0): ?><li class="page"><a href="chatmajor_view_all.php?page2=<?php echo $page-2 ?>&searchcustomer=<?php echo $searchname; ?>&searchname2=<?php echo $searchname2; ?>"><?php echo $page-2 ?></a></li><?php endif; ?>
																				<?php if ($page-1 > 0): ?><li class="page"><a href="chatmajor_view_all.php?page2=<?php echo $page-1 ?>&searchcustomer=<?php echo $searchname; ?>&searchname2=<?php echo $searchname2; ?>"><?php echo $page-1 ?></a></li><?php endif; ?>

																				<li class="currentpage"><a href="chatmajor_view_all.php?page2=<?php echo $page ?>&searchcustomer=<?php echo $searchname; ?>&searchname2=<?php echo $searchname2; ?>"><?php echo $page ?></a></li>

																				<?php if ($page+1 < ceil($total_record / $perpage)+1): ?><li class="page"><a href="chatmajor_view_all.php?page2=<?php echo $page+1 ?>&searchcustomer=<?php echo $searchname; ?>&searchname2=<?php echo $searchname2; ?>"><?php echo $page+1 ?></a></li><?php endif; ?>
																				<?php if ($page+2 < ceil($total_record / $perpage)+1): ?><li class="page"><a href="chatmajor_view_all.php?page2=<?php echo $page+2 ?>&searchcustomer=<?php echo $searchname; ?>&searchname2=<?php echo $searchname2; ?>"><?php echo $page+2 ?></a></li><?php endif; ?>

																				<?php if ($page < ceil($total_record / $perpage)-2): ?>
																				<li class="dots">...</li>
																				<li class="end"><a href="chatmajor_view_all.php?page2=<?php echo ceil($total_record / $perpage) ?>&searchcustomer=<?php echo $searchname; ?>&searchname2=<?php echo $searchname2; ?>"><?php echo ceil($total_record / $perpage) ?></a></li>
																				<?php endif; ?>

																				<?php if ($page < ceil($total_record / $perpage)): ?>
																				<li class="next"><a href="chatmajor_view_all.php?page2=<?php echo $page+1 ?>&searchcustomer=<?php echo $searchname; ?>&searchname2=<?php echo $searchname2; ?>">Next</a></li>
																				<?php endif; ?>
																			</ul>
											<?php endif; ?>
							...
							<table id="key_product"  class=" table    tablemobile  " border="0"    >
							 <thead> 
										...
										$sql2 = "SELECT a.*, b.name FROM datachat a
										Inner Join customer b On a.customer = b.pk
											where a.datesave != '' and drop_chat  = 'อยู่ในระหว่างการติดตาม'
											".$addcode.$addcode2."  
