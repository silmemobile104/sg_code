...
include('../database.php');
	...
	if(empty($create_by)){
		...
		$bill_no = ""; 
		$GGyear= date('Y')+543 ; 
		$sql2 = "SELECT count(pk) as total FROM run_cleam_backnew_one  ";
		...
		$bill_no =  "SGC".date('Ymd')."-".$total; 
		$strSQL = "INSERT INTO run_cleam_backnew_one (bill_no) VALUES  ('".$bill_no."')";  
		$objQuery = mysqli_query($objCon, $strSQL);

		  
		

		$strSQL = " Update list_chk_cleam_back Set  
					bill_no = '".$bill_no."' ,             
...
<form id="frm" method="post" action="cleam_backnew_one_edit.php">
