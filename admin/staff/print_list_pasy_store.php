...
?>
  ...
  <style>
	...
	$sql2 = " SELECT * FROM list_order_store where  pasy_bill = '".$pasy_bill."' Group By bill_no  order by pk asc   "; 
	...
	while($objResult2 = mysqli_fetch_array($query2))
	{
		...
		$menuid = "-";
		$sql_c = "SELECT * FROM list_order_store where pk = '".$objResult2["pkselect"]."'   order by pk asc  "; 
