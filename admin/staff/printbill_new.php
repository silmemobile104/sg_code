  ...
  <style>
  	...
  	<?php
		...
		{   
			...
			$sql_c = "SELECT * FROM customer where pk = '".$customer."'   order by pk asc  "; 
			$query_c = mysqli_query($objCon,$sql_c);
			while($objResult_c = mysqli_fetch_array($query_c))
			{ 
					$name =  $objResult_c["name"]; 
					$facebook =  $objResult_c["facebook"]; 
					$telphone =  $objResult_c["telphone"]; 
			}
	...
	?> 
  	...
  	<table width="100%" border="0"   > 
		  ...
		  <tr>
			 ...
			 <td align="right" width="65%" valign="top" height="0px"  >  
			 <div style="margin-left: 5px; margin-right: 5px; margin-top: 5px; "  >  
				<font size="2px" style="font-size: 18px;">   
