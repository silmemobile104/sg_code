                  ...
                  <div style="margin-top: 6px;" > 
                     <font size="4px" color="#000000">  ออกใบเส็รจระค่าบริการ   </font>   
                      ...
                      <?php if(empty($_GET["page"])){ ?>
                      	...
                      	<form action="paper_tanai3.php" method="get" >
					...
					where a.bill_no != '' and a.tanaidata = '".$tanaidata."'  and a.tanai_chk = 'OK' and a.tanaidata != ''    
					".$addcode.$addcode2."  
					order by a.pk asc    "; 
					...
					<?php if (ceil($total_record / $perpage) > 0): ?>
						 <ul class="pagination">
						<?php if ($page > 1): ?>
						<li class="prev"><a href="paper_tanai3_select.php?page2=<?php echo $page-1 ?>&searchname=<?php echo $searchname; ?>&searchname2=<?php echo $searchname2; ?>&searchtype=<?php echo $searchtype; ?>&bill_no=<?php echo $bill_no; ?>&tanaidata=<?php echo $tanaidata; ?>">Prev</a></li>
						<?php endif; ?>

						<?php if ($page > 3): ?>
						<li class="start"><a href="paper_tanai3_select.php?page2=1&searchname=<?php echo $searchname; ?>&searchname2=<?php echo $searchname2; ?>&searchtype=<?php echo $searchtype; ?>&bill_no=<?php echo $bill_no; ?>&tanaidata=<?php echo $tanaidata; ?>">1</a></li>
						<li class="dots">...</li>
						<?php endif; ?>

						<?php if ($page-2 > 0): ?><li class="page"><a href="paper_tanai3_select.php?page2=<?php echo $page-2 ?>&searchname=<?php echo $searchname; ?>&searchname2=<?php echo $searchname2; ?>&searchtype=<?php echo $searchtype; ?>&bill_no=<?php echo $bill_no; ?>&tanaidata=<?php echo $tanaidata; ?>"><?php echo $page-2 ?></a></li><?php endif; ?>
						<?php if ($page-1 > 0): ?><li class="page"><a href="paper_tanai3_select.php?page2=<?php echo $page-1 ?>&searchname=<?php echo $searchname; ?>&searchname2=<?php echo $searchname2; ?>&searchtype=<?php echo $searchtype; ?>&bill_no=<?php echo $bill_no; ?>&tanaidata=<?php echo $tanaidata; ?>"><?php echo $page-1 ?></a></li><?php endif; ?>

						<li class="currentpage"><a href="paper_tanai3_select.php?page2=<?php echo $page ?>&searchname=<?php echo $searchname; ?>&searchname2=<?php echo $searchname2; ?>&searchtype=<?php echo $searchtype; ?>&bill_no=<?php echo $bill_no; ?>"><?php echo $page ?></a></li>

						<?php if ($page+1 < ceil($total_record / $perpage)+1): ?><li class="page"><a href="paper_tanai3_select.php?page2=<?php echo $page+1 ?>&searchname=<?php echo $searchname; ?>&searchname2=<?php echo $searchname2; ?>&searchtype=<?php echo $searchtype; ?>&bill_no=<?php echo $bill_no; ?>&tanaidata=<?php echo $tanaidata; ?>"><?php echo $page+1 ?></a></li><?php endif; ?>
						<?php if ($page+2 < ceil($total_record / $perpage)+1): ?><li class="page"><a href="paper_tanai3_select.php?page2=<?php echo $page+2 ?>&searchname=<?php echo $searchname; ?>&searchname2=<?php echo $searchname2; ?>&searchtype=<?php echo $searchtype; ?>&bill_no=<?php echo $bill_no; ?>&tanaidata=<?php echo $tanaidata; ?>"><?php echo $page+2 ?></a></li><?php endif; ?>

						<?php if ($page < ceil($total_record / $perpage)-2): ?>
						<li class="dots">...</li>
						<li class="end"><a href="paper_tanai3_select.php?page2=<?php echo ceil($total_record / $perpage) ?>&searchname=<?php echo $searchname; ?>&searchname2=<?php echo $searchname2; ?>&searchtype=<?php echo $searchtype; ?>&bill_no=<?php echo $bill_no; ?>&tanaidata=<?php echo $tanaidata; ?>"><?php echo ceil($total_record / $perpage) ?></a></li>
						<?php endif; ?>

						<?php if ($page < ceil($total_record / $perpage)): ?>
						<li class="next"><a href="paper_tanai3_select.php?page2=<?php echo $page+1 ?>&searchname=<?php echo $searchname; ?>&searchname2=<?php echo $searchname2; ?>&searchtype=<?php echo $searchtype; ?>&bill_no=<?php echo $bill_no; ?>&tanaidata=<?php echo $tanaidata; ?>">Next</a></li>
						<?php endif; ?>
					</ul>
					<?php endif; ?>
					...
					<?php 
						...
						$sql2 = "  SELECT a.*, b.name FROM list_order a 
						Inner Join customer b On a.customer = b.pk
						where a.bill_no != '' and a.tanaidata = '".$tanaidata."'  and a.tanai_chk = 'OK' and a.tanaidata != '' and a.tanai_pasy_bill = ''  
						".$addcode.$addcode2."  
						...
						?>
					 <form role="form" name="frmMain" method="post" action="save_confrim_tanai.php" enctype="multipart/form-data" onsubmit="return validateForm()"  > 
						
						<input type="hidden" id="totalall" name="totalall" value="<?php echo $i; ?>">
					...
					<script>  
					 ...
					 function Saveallbill() 
					 {
						 ...
						 var loop = 1;
						 for(loop = 1; loop <= totalall; loop++){
							 var savepk =	document.getElementById("datasaveproduct"+loop).value;  

								document.getElementById("hdd"+loop).style.display = "none";

								//// alert("save_cart.php?savepk="+savepk+"&total="+gettotal);
								 $.ajax({
								 type: "POST",
								 url: "save_tanal_bill_pasy2.php?savepk="+savepk,
								 data: {},
					...
					?>	 
					  ...
					  <div class="col-lg-12"  align="left"  > 
							...
							<button type="button"  class="btn btn-primary" style=" <?php echo $colorbtns1s; ?> " onClick="Saveallbill()" > <font color="<?php echo $txtcolor2; ?>" size="3px" class="serif1"  >     ยกเลิกบิลทั้งหมด   </font> </button>  

							 
								 
							<button type="button"  class="btn btn-primary" style=" <?php echo $colorbtns2s; ?> "  data-toggle="modal" data-target="#smallmodal"  > 
					...
					?>
					<tr style="background-color: <?php echo $bg ?>; " id="hdd<?php echo $i; ?>"> 
					 ...
					 <a onClick="Saveordercart<?php echo $i; ?>()"   > 
						<button type="button" class="btn btn-sm" style="background-color: #0199A7; border-radius: 5px;  border-color: #0199A7; margin-top: 5px; "  > <font color="#FFF" size="2px" class="serif1" style="  font-size: 13px; " >    ลบ   </font> </button>   
					 </a>

					 </font></div></td>  
					 
					 
						<input type="hidden" id="datasaveproduct<?php echo $i; ?>" value="<?php echo $objResult2["bill_no"]; ?>"   > 
						<script>
						 function Saveordercart<?php echo $i; ?>() { 
						   var savepk =	document.getElementById("datasaveproduct<?php echo $i; ?>").value;  

							document.getElementById("hdd<?php echo $i; ?>").style.display = "none";

							 ///// alert("save_tanal_bill_pasy.php?savepk="+savepk);
							 $.ajax({
							 type: "POST",
							 url: "save_tanal_bill_pasy2.php?savepk="+savepk,
							 data: {},
					...
					<?php $i++; $totalprice1 += $priceother; } ?>
					 ...
					 <div class="col-lg-12"  align="left" style="margin-top: 25px; "  > </div>  
						...
						<font color = '#000' size="3px" > ต้องการคิดภาษีมูลค่าเพิ่มหรือไม่ </font>   
						<div class="input-group   "  style="border: 1px solid #C9C9C9; border-radius: 4px; height: 40px; ">  
						<select class="form-control" id="tanai_pasy_addon" name="tanai_pasy_addon" required style="width:30px;-webkit-appearance: none; border:  0px solid #FFF; border-radius: 5px;  "   >   
						<?php 
							$sql = "SELECT * FROM drop_tanai_pasy where name = '".$tanai_pasy_addon."' order by pk asc  "; 
							$query = mysqli_query($objCon,$sql);
							while($objResult = mysqli_fetch_array($query))
							{ 
						?>
						...
						?>    
						<?php 
							$sql = "SELECT * FROM drop_tanai_pasy where pk != '".$tanai_pasy_addon."' order by pk asc  "; 
							$query = mysqli_query($objCon,$sql);
							while($objResult = mysqli_fetch_array($query))
							{ 
						?>
