       ...
       <!-- page content -->
        	<div class="right_col" role="main" style="background-color: #F5F5F7; " >
             ...
             <div style="margin-top: 1px;" > 
                     <font size="4px" color="#000000">  แก้ไขบิลใบเสร็จชำระค่าซ่อม    </font>  
                     <br> 
                     <font size="2px" color="#000000">  หน้าเเรก > แก้ไขบิลใบเสร็จชำระค่าซ่อม     </font>   
                     <div > &nbsp; </div>
             </div> 
             </font> 
             </div>
                    	 ...
                    	 <script>  
							 ...
							 {  
							  ...
							  var bill_no = document.getElementById("bill_no").value;  
								...
								$.ajax({
								type: "GET",
								url: "show_bill_cleam_select_re.php?bill_no="+bill_no,
							...
							<font color="red" size="3px" class="serif1"  > 
						      **** หมายเหตุ 
                      	    ...
                      	    <div class="col-lg-12"  align="left"  > 
								...
								<button type="button"  class="btn btn-primary" style=" <?php echo $colorbtns1s; ?> "   > <font color="<?php echo $txtcolor2; ?>" size="3px" class="serif1"  >   ย้อนกลับไปหน้ารายการแก้ไขบิล   </font> </button>  
