...
?>
	...
	<thead>  
	 <tr>
		...
		<font size="3px" class="serif2" color="#000" style=" font-size: 15px; "> ยอดการซ่อมมือถือ  </font></div></th>       
		<th width="3%" bgcolor="#E2E7EC" style="border: 0px solid #FFF;  border-right: 1px solid #FFF;  "><div align="center"> 
		<font size="3px" class="serif2" color="#000" style=" font-size: 15px; "> ต้นทุนงานซ่อม  </font></div></th>       
		<th width="3%" bgcolor="#E2E7EC" style="border: 0px solid #FFF;  border-right: 1px solid #FFF;  "><div align="center"> 
		<font size="3px" class="serif2" color="#000" style=" font-size: 15px; "> กำไร (ขาดทุน) ทั้งสิ้น  </font></div></th> 
	 </tr>
	</thead>							
	...
	<?php  
	   ...
	   for($x = 1; $x <= 12; $x++){
		...
		$sql2 = "  SELECT * FROM mobile_restore   where  bill_no != ''  ".$addcode_re."  order by  pk asc  ";   
		...
		{         
			...
			$cal1 = $objResult2["price1"] - $objResult2["price2"];
			if($cal1 <= 0){
				$cal1 = 0;
			}
			
			
			$totaldata1+= $objResult2["price2"];
			$totaldata2+= $objResult2["price1"];	 
		   ...
		   $totaldata3 = $totaldata2-$totaldata1;
