...
<tbody>
										...
										$sql2 = " SELECT a.*, b.name, c.typedata_2 FROM list_order  a
											...
											where a.bill_no != ''      and a.chk = '' and a.status = 'ปกติ' and a.contactstatus = 'อนุมัติแล้ว'
											".$major.$major_store."  
											order by a.pk asc   ";  
										...
										<td style=" border-left: 0px solid #F2F2F2; "><div align="center"><font size="3px" color="Black" style=" font-size: 13px; " > <?php echo $objResult2["bill_no"]; ?> C </font></div></td> 
