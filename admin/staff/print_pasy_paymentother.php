...
$namemember5 = "";
$sql2 = "  SELECT *  FROM paymentother   where pk = '".$bill_no."'     ";  
...
{      
	...
	$price = $objResult2["data2"];    
	$create_date = $objResult2["create_date2"];    
} 			 
...
<td><div align="left" style=" margin-left: 5px; margin-right: 5px; "><font size="3px" color="Black" style=" font-size: 18px; " > <?php echo $data1; ?> </font></div></td> 
 
<td><div align="center"><font size="3px" color="Black" style=" font-size: 18px; " > <?php echo number_format(0+$data2); ?> </font></div></td>
