                      ...
                      <?php if(empty($_GET["page"])){ ?>
							...
							<table id="key_product"  class=" table    tablemobile  " border="0" style="width: 2040px;"    >
								...
								<tbody>
										...
										<a href="contact_cleam.php?bill_no=<?php echo $objResult2["bill_no"]; ?>"   class="  btn-sm " style="background-color: #FFF; border-radius: 5px;  border-color: #F77369; border: 1px solid  #F77369; display: none; " id="nextpage<?php echo $objResult2["pk"]; ?>" >
										<font size="3px" color="#F77369" style=" font-size: 13px; " >  ทำรายการเครม </font></a>
										...
										<input type="hidden" id="pageget" name="pageget" value="ทำรายการเครม">
