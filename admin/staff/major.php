        	...
        	<div class="right_col" role="main" style="background-color: #F5F5F7; " >
             ...
             <div class=" col-lg-12 " style="  " align="left" >
                  ...
                  <div style="margin-top: 1px;" > 
                     <font size="4px" color="#000000">  แก้ไชช้อมูลสาขา   </font>  
                     <br> 
                     <font size="2px" color="#000000">  หน้าเเรก > แก้ไชช้อมูลสาขา  </font>   
                     <div > &nbsp; </div>
                  </div> 
                  </font> 
                  </div>
              ...
              <div class=" col-lg-12 "  style="margin-top: -15px;"  > 
                <div class="x_panel"  style="background-color: #FFFFFF;  border-radius: 10px; " > 
                  ...
                  <div style="margin-top: 6px;" > 
                     <font size="4px" color="#000000">  เพิ่มข้อมูลสาขา   </font>   
                  </div> 
                  </font> 
                  </div>
                      ...
                      <?php if(empty($_GET["page"])){  
						...
						?>  
                  		     <form role="form" name="frmMain" method="post" action="save_major_update.php" enctype="multipart/form-data" onsubmit="return validateForm()" > 
							<input type="hidden" name="idupdate" id="idupdate" class="form-control " value="1" >
							  ...
							  <div class="col-md-5" style=" margin-top:  15px; " > 
							   ...
							   <div class="col-md-12 "> 
								  <div class="form-group"> 
									 <font class="serif" size="3px" color="black" for="address"> ชื่อสาขา </font>
							  ...
							  <div class="col-md-5" style=" margin-top:  15px; " > 
							   ...
							   <div class="col-md-12 "> 
								  <div class="form-group"> 
									 <font class="serif" size="3px" color="black" for="address"> เลขที่ผู้เสียภาษี </font>
									 <input type="text" class="form-control" id="pasy" name="pasy"   autocomplete="off" required  style="border: 1px solid #CACACA; height: 40px;  border-radius: 5px; background-color: #FFF; "    value="<?php echo $pasy; ?>"   onkeypress="return (event.charCode !=8 && event.charCode ==0 || ( event.charCode == 46 || (event.charCode >= 48 && event.charCode <= 57)))"  >
								  </div>
							   </div>  
