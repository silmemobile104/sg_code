...
?>
 ...
 <?php
		...
		{   
			...
			if($objResult_npl["orderdata"] != $order_check){
				
				if(empty($objResult_npl["income"])){ 
					if(($objResult_npl["addon"] == "")){ 
						$order_check  =  $objResult_npl["orderdata"];
						$countloopnopay_pay  +=  $objResult_npl["money"];
						$chk_total2++; 
					}
				}
			}
...
?> 
    ...
    <table width="100%" border="0">
    	<tr>
    		...
    		<img src="<?php echo $showimg1; ?>" style=" width: 80px; " >
			</div>
    ...
    <table width="100%" border="0">
    	<tr>
   		 ...
   		 &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; ต่อมาปรากฏว่าท่านได้ผิดนัดชำระค่าเช่าซื้อจำนวน <?php echo $chk_total2; ?> งวด เป็นเงินจำนวนทั้งสิ้น <?php echo number_format(0+$countloopnopay_pay); ?> บาท (<?php echo  convert(0+$countloopnopay_pay); ?>) และค่าปรับ <?php echo number_format(0+$discountshow); ?> พร้อมกับค่าติดตาม 1,000 บาท (หนึ่งพันบาทถ้วน) การกระทำที่ท่านเป็นเหตุในทางร้าน 
   		
    			<div style="margin-top: 5px;" > </div>
   		
   		 &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; ดังนั้นข้าพเจ้าในฐานะทนายความผู้ได้รับมอบหมายอำนาจจาก นายพิสิฏฐ์ จรรยา จึงบอกเลิกสัญญาเช่าซื้อดังกล่าวนับตั้งแต่วันที่ลงหนังสือสัญญาและให้ท่านนำเงินค่าเช่าซื้อที่ค้างจำนวน <?php echo number_format(0+$discountshow+$allmoney+1000); ?> บาท  (<?php echo convert(0+$discountshow+$allmoney+1000); ?>) พร้อมดอกเบี้ยร้อยละ 5 ต่อปีไปชำระให้แก่ร้าน <?php echo $name_major1; ?> หรือส่งมอบโทรศัพท์มือถือในสภาพที่สมบูรณ์คืนแก่ร้าน <?php echo $name_major1; ?> ภายในกำหนด 7 วันนับตั้งแต่ที่ท่านได้รับหนังสือบอกกล่าวฉบับนี้
   		
    			<div style="margin-top: 5px;" > </div>
    		&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;	อนึ่งหากท่านมีข้อสอบถามเพิ่มเติม ท่านสามารถติดต่อสอบถามได้ที่โทรศัพท์หมายเลข <?php echo $telphonedata; ?> มิฉะนั้น ข้าพเจ้ามีความจำเป็นต้องดำเนินคดีกับท่านตามกฎหมายต่อไป
