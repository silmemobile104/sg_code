...
<title>  ใบกำกับภาษี / ใบส่งสินค้า / ใบแจ้งหนี้  </title>
</head>  
<style>
@font-face {
  ...
  <style>
	...
	?> 
  	...
  	<table width="100%" border="0"   >  
		  <tr>
			 ...
			 <div style="margin-left: 5px; margin-right: 5px; margin-top: 5px; "  >  
				...
				สำนักงานใหญ่ :  <?php echo $name_major1; ?>     <?php echo $name_major2; ?>  โทร. <?php echo $name_major3; ?>    เลขประจำวผู้เสียภาษี <?php echo $name_major4; ?>   
				</font>
		  ...
		  <tr> 
			 ...
			 <div style="margin-left: 5px; margin-right: 5px; margin-top: 5px; "  >  
				<font size="2px" style="font-size: 20px;">   
			 	<b>    ใบกำกับภาษี / ใบส่งสินค้า / ใบแจ้งหนี้	</b>  
			    <div style=" margin-top: 0px; "  >  </div> 		
				<b>    TAX INVOICE / DERIVERY ORDER / INVOICE	</b>	 
				</font>
			 </div>
			 </td>
		  </tr>   
  	...
  	<table width="100%" border="0"   > 
		  ...
		  <tr>
			 <td align="left" width="70%" valign="top" height="0px"  >  
			 <div style="margin-left: 5px; margin-right: 5px; margin-top: 5px; "  >  
			 ...
			 <div style="margin-left: 5px; margin-right: 5px; margin-top: 5px; "  >  
				<font size="2px" style="font-size: 18px;">   
			 	  <b>  เลขที่        </b> IVSG<?php echo $bill_no; ?> 
			 	    <div style=" margin-top: 2px;" >  </div>
	...
	<font size="3px" class="serif2" color="#000" style=" font-size: 16px; ">   <b>   รหัสสินค้า  </b>    </font></div></td>   
	 
	<td width="2%"  ><div align="center"> 
	<font size="3px" class="serif2" color="#000" style=" font-size: 16px; ">   <b>    รายละเอียด  </b>    </font></div></td>   
	 
	<td width="2%"  ><div align="center"> 
	<font size="3px" class="serif2" color="#000" style=" font-size: 16px; ">   <b>    จำนวน  </b>    </font></div></td>   
	 
	<td width="2%"  ><div align="center"> 
	<font size="3px" class="serif2" color="#000" style=" font-size: 16px; ">   <b>    หน่วย   </b>   </font></div></td>    
	...
	<td ><div align="center"><font size="3px" color="Black" style=" font-size: 13px; " > &nbsp; </font></div></td>  
     ...
     <?php } ?>   
    <tr >  								
	<td colspan="5" ><div align="center"><font size="3px" color="Black" style=" font-size: 16px; " > 
	(  <?php echo Convert($moneydata-$moneydown); ?>  )
	</font></div></td>   				
	<td colspan="1" ><div align="left"><font size="3px" color="Black" style=" font-size: 13px; " > 
	 &nbsp;รวมเงิน
	<div style=" margin-top: 0px; " > </div>
	<font size="3px" color="Black" style=" font-size: 10px; " > &nbsp; TOTAL   </font>
	 </div></td>  				
    ...
    <tr >  								
	<td colspan="5" rowspan="5" valign="top" style=" border: 1px solid #FFF; border-right: 1px solid #000;" ><div align="left"><font size="3px" color="Black" style=" font-size: 14px; " > 
	<div style=" margin-top: 5px; " > </div>
	หมายเหตุ :
	<div style=" margin-top: 0px; " > </div>
	1. กรณีชำระเงินโดยเช็คกรุณาสั่งจ่ายเช็คขีดคร่อมในนาม "บริษัท ตัวอย่าง จำกัด" เท่านั้น
	<div style=" margin-top: 0px; " > </div>
	...
	<div style=" margin-top: 0px; " > </div>
	3. บริษัทฯ ขอสงวนสิทธิ์ในการแก้ไขใบกำกับภาษีภายใน 7 วัน นับจากวันที่ระบุในใบกำกับภาษี (ผิด ตก ยกเว้น E. & OE.)
	<div style=" margin-top: 5px; " > </div> 
	</font></div></td>   	 
	</tr>      
	...
	<td colspan="1" style=" border: 1px solid #000; " ><div align="left"><font size="3px" color="Black" style=" font-size: 13px; " > 
	 &nbsp;ภาษีมูลค่าเพิ่ม7%
	<div style=" margin-top: 0px; " > </div>
	<font size="3px" color="Black" style=" font-size: 10px; " > &nbsp; VAT   </font>
	 </div></td>  				
	<td colspan="1" ><div align="right"><font size="3px" color="Black" style=" font-size: 13px; " > 
	<?php 
		$vat = (($moneydata-$moneydown) * 100 )  / 107;
		
		echo number_format(0+($moneydata-$moneydown) - $vat); 
	...
	<td colspan="1" style=" border: 1px solid #000; " ><div align="left"><font size="3px" color="Black" style=" font-size: 13px; " > 
	 &nbsp;ยอดเงินสุทธิ
	<div style=" margin-top: 0px; " > </div>
	<font size="3px" color="Black" style=" font-size: 10px; " > &nbsp; GRAND TOTAL   </font>
	 </div></td>  		 	
	<td colspan="1" ><div align="right"><font size="3px" color="Black" style=" font-size: 13px; " > 
	<?php  
		$vat = (($moneydata-$moneydown) * 100 )  / 107;
	...
	<tr>    
      ...
      <td width="30%" >
		 ...
		 <div style=" margin-top: 10px; margin-left: 5px; margin-right: 5px; margin-bottom: 10px;  " >
	 	   ได้รับสินค้าตามรายการข้างต้นไว้เรียบร้อยแล้ว
		 <div style=" margin-top: 5px; " > </div>
      	  ผู้รับสินค้า.............................................................................
		 <div style=" margin-top: 0px; " > </div>
		  วันที่..................................................................................... 
      ...
      <td width="30%" >
		 ...
		 <tr>  
      	 ...
      	 <font size="3px" color="Black" style=" font-size: 13px; " > 
		 <div style=" margin-top: 10px; margin-left: 5px; margin-right: 5px;  margin-bottom: 10px;  " >
	 	   ในนาม บริษัท เอสจี ลิสซิ่ง พลัส จำกัด
		 <div style=" margin-top: 5px; " > </div>
      	  ..................................................................................
		 <div style=" margin-top: 0px; " > </div>
		  ผู้มีอำนาจลงนาม 
