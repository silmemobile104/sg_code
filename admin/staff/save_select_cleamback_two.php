...
include('../database.php');
		...
		$obj = json_decode($input); 
			...
			if(empty($member_user)){
				    ...
				    $major2_chk = "";
					$strSQL2 = "SELECT * FROM list_chk_cleam_back_two WHERE bill_no = '' and create_by = '".$_SESSION["UserID"]."'  ";
					...
					$strSQL = "SELECT * FROM list_chk_cleam_back_two WHERE pkselect = '".$menuid."' and bill_no = '' ";
					$objQuery = mysqli_query($objCon, $strSQL);
