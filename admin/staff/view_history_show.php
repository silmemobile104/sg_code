						...
						<hr>
							...
							<table id="key_product"  class=" table    tablemobile  " border="0" style=" width: 1950px; "    >
							 ...
							 <tbody>
								...
								$sql2 = "SELECT * FROM history_payment where bill_no = '".$_GET["bill_no"]."' and addon = ''   ".$code_check2."   order by create_date2 asc ";  
								...
								{     
									...
									{ 
										...
										if(!empty($moneydiccount)){ 
											  $totalall += (-$moneydiccount);
										} 
								...
								?>
										...
										<td><div align="center"><font size="2px" color="Black" style=" font-size: 13px; ">   
											 ...
											 <?php echo  number_format(0+$moneydiccount); ?> 
										</font></div></td>  
							 
									    <td style=" border-left: 0px solid #F2F2F2; "><div align="center"><font size="3px" color="Black" style=" font-size: 13px; " >
									     <?php echo number_format(0+$objResult["discoubt"]); ?>
									    </font></div></td> 
