            ...
            <div id="sidebar-menu" class="main_menu_side hidden-print  main_menu" style="background-color: #323D55; margin-top: -10px; ">
              <div class="menu_section"> 
                ...
                <ul class="nav side-menu">
                  	...
                  	<li class="<?php echo $active1; ?>" ><a href="check_contact_store.php?page=edit"> <img src="images/c1.png" style="width: 13px; margin-left: 5px; " > <font size="2px"  color="<?php echo $page1; ?>"> &nbsp;  เช็คสัญญา </font> </a> </li> 
                   ...
                   <li><a> <img src="images/c3.png" style="width: 13px; margin-left: 5px;  " >  <font size="2px"  color="<?php echo $page4; ?>"> &nbsp;   ตรวจสอบระบบ </font> <font style=" font-size: 10px; " >  <span class="fa fa-chevron-down"></span>  </font> </a>
                    <ul class="nav child_menu">  
                     ...
                     <li style="margin-top: 2px; " class="<?php echo $active21; ?>" ><a href="tokenline.php"> &nbsp;  <font size="1px" style=" font-size: 13px; "  color="#A3AFB6">  &nbsp; Token Line </font> </a>  </li> 
						 
                     <li style="margin-top: 2px; " class="<?php echo $active21; ?>" ><a href="startpricedata.php"> &nbsp;  <font size="1px" style=" font-size: 13px; "  color="#A3AFB6">  &nbsp; กำหนดราคาผ่อน  </font> </a>  </li> 
                     ...
                     <li style="margin-top: 2px; " class="<?php echo $active21; ?>" ><a href="major.php"> &nbsp;  <font size="1px" style=" font-size: 13px; "  color="#A3AFB6">  &nbsp; แก้ไชช้อมูลสาขา </font> </a>  </li>   
                  	 ...
                  	 <li style="margin-top: 2px; " class="<?php echo $active22; ?>" ><a href="store.php"> &nbsp;  <font size="1px" style=" font-size: 13px; "  color="#A3AFB6">  &nbsp; เพิ่มข้อมูลร้านค้า </font> </a>  </li>  
                  	  ...
                  	  <!--
                  	 <li style="margin-top: 2px; " class="<?php echo $active23; ?>" ><a href="type_staff.php"> &nbsp; <font size="1px" style=" font-size: 13px; "  color="#A3AFB6">  &nbsp; เพิ่มสถานะผู้ใช้งาน </font> </a>  </li>   
                  	 --->
                  	  
					 <?php 
						$sql = "SELECT * FROM drop_type_staff  where pk != '7' and pk != '8'   order by pk asc  "; 
					 ...
					 <li style="margin-top: 2px; " class="<?php echo $active24; ?>" ><a href="stafftanai.php"> &nbsp; <font size="1px" style=" font-size: 13px; "  color="#A3AFB6">  &nbsp; ข้อมูลทนาย  </font> </a> </li> 
                 	  
                  	 <li style="margin-top: 2px; " class="<?php echo $active25; ?>" ><a href="staffpartner.php"> &nbsp;  <font size="1px" style=" font-size: 13px; "  color="#A3AFB6">  &nbsp; พาทเนอร์  </font> </a>  </li> 
                    ...
                    <ul class="nav child_menu">  
                  	...
                  	<li style="margin-top: 2px; " class="<?php echo $active4; ?>" ><a href="checkgradecontactall.php"> &nbsp;  <font size="1px" style=" font-size: 13px; "  color="#A3AFB6">  &nbsp; เกรดลูกค้า  </font> </a>  </li>
                    
                  	<li style="margin-top: 2px; " class="<?php echo $active4; ?>" ><a href="checkgradecontact.php"> &nbsp;  <font size="1px" style=" font-size: 13px; "  color="#A3AFB6">  &nbsp; เกรดลูกค้ารายลุคคล  </font> </a>  </li>
                    ...
                    <ul class="nav child_menu">  
                  	...
                  	<li style="margin-top: 2px; "><a href="savepayment_check1_new.php"> &nbsp;  <font size="1px" style=" font-size: 13px; "  color="#A3AFB6">  &nbsp; ยอดเก็บเงิน ปกติ และ NPL   </font> </a>  </li>
                  	...
                  	<li style="margin-top: 2px; " class="<?php echo $active1; ?>" ><a href="paper_tanai1.php"> &nbsp;  <font size="1px" style=" font-size: 13px; "  color="#A3AFB6">  &nbsp; รายชื่อถูกดำเนินคดี  </font> </a>  </li>
                  	<li style="margin-top: 2px; " class="<?php echo $active1; ?>" ><a href="paper_tanai2.php"> &nbsp;  <font size="1px" style=" font-size: 13px; "  color="#A3AFB6">  &nbsp; กำหนดค่าใช้จ่ายดำเนินคดี  </font> </a>  </li>
                  	<li style="margin-top: 2px; " class="<?php echo $active1; ?>" ><a href="paper_tanai3.php"> &nbsp;  <font size="1px" style=" font-size: 13px; "  color="#A3AFB6">  &nbsp; ออกใบเส็รจระค่าบริการ  </font> </a>  </li>
                    ...
                    <ul class="nav child_menu">  
                  	...
                  	<li style="margin-top: 2px; " class="<?php echo $active1; ?>" ><a href="typepartner.php"> &nbsp;  <font size="1px" style=" font-size: 13px; "  color="#A3AFB6">  &nbsp; ประเภทรุ่นมือถือ (พาทเนอร์)  </font> </a>  </li> 
                    ...
                    <li><a> <img src="images/c5.png" style="width: 13px; margin-left: 5px;  " >  <font size="2px"  color="<?php echo $page4; ?>"> &nbsp; ผู้ถือหุ้น </font> <font style=" font-size: 10px; " >  <span class="fa fa-chevron-down"></span>  </font> </a>
                    <ul class="nav child_menu">  
                     
                  	<li style="margin-top: 2px; "><a href="customerpunpon.php"> &nbsp;  <font size="1px" style=" font-size: 13px; "  color="#A3AFB6">  &nbsp; ข้อมูลผู้ถือหุ้น  </font> </a>  </li>
                  	
                  	<li style="margin-top: 2px; " class="<?php echo $active1; ?>" ><a href="pricepunpon.php"> &nbsp;  <font size="1px" style=" font-size: 13px; "  color="#A3AFB6">  &nbsp; จ่ายเงินปันผลประจำเดือน  </font> </a>  </li> 
                  	
                  	<li style="margin-top: 2px; " class="<?php echo $active1; ?>" ><a href="pricesomtub.php"> &nbsp;  <font size="1px" style=" font-size: 13px; "  color="#A3AFB6">  &nbsp; เงินทุนสะสม  </font> </a>  </li> 
                    ...
                    <li><a> <img src="images/c6.png" style="width: 13px; margin-left: 5px;  " >  <font size="2px"  color="<?php echo $page4; ?>"> &nbsp; รายงานแฟ้มสถานะหนี้ </font> <font style=" font-size: 10px; " >  <span class="fa fa-chevron-down"></span>  </font> </a>
                    <ul class="nav child_menu">     
                    
                    
                    <li style="margin-top: 2px; " class="<?php echo $active1; ?>" ><a href="reportnew29.php"> &nbsp;  <font size="1px" style=" font-size: 13px; "  color="#A3AFB6">  &nbsp; สถานะหนี้บัญชี้  </font> </a>  </li>
          ...
          <div class="nav_menu"  style="background-color: #FFF; height: 57px;  ">
              ...
              <ul class=" navbar-right">
                ...
                <div class="col-md-12" align="right"> 
                   ...
                   <button class="btn btn-sm" align="center"   href="javascript:;" id="navbarDropdown1" data-toggle="dropdown" aria-expanded="false">
