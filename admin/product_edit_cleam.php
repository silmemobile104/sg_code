                  ...
                  <div style="margin-top: 6px;" > 
                     <font size="4px" color="#000000">  เคลมสินค้า   </font>   
                      ...
                      <?php if(empty($_GET["page"])){ ?>
						  ...
						  <form role="form" name="frmMain" method="post" action="save_product_update2.php" enctype="multipart/form-data" onsubmit="return validateForm()" >
							...
							<div class="form-group">
							   <font color = '#000' size="3px" > สถานะ </font>      
							    ...
							    <?php if($status == "ไม่พร้อมจำหน่าย"){ ?>
							    		...
							    		<?php 
										$sql = "SELECT * FROM drop_cleam_product2  where name = '".$status."'   order by pk asc  "; 
										$query = mysqli_query($objCon,$sql);
										while($objResult = mysqli_fetch_array($query))
										{ 
										?>
							    ...
							    <?php }else{ ?>
							    		...
							    		<?php 
										$sql = "SELECT * FROM drop_cleam_product2  where name = '".$status."'  and name != 'ไม่พร้อมจำหน่าย' order by pk asc  "; 
										$query = mysqli_query($objCon,$sql);
										while($objResult = mysqli_fetch_array($query))
										{ 
										?>
