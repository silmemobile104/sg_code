...
?>
  ...
  <style>
	...
	?> 
		  ...
		  <tr>
			 ...
			 <div style="margin-left: 5px; margin-right: 5px; margin-top: 5px; "  >  
				<font size="2px" style="font-size: 18px;">   
			 	 <b> วันที่ทำสัญญา   </b>  <?php echo DateThai($create_date)." ".DateThai2($create_date); ?>
				</font>
			 </div>
			 </td>
			 ...
			 <div style="margin-left: 5px; margin-right: 5px; margin-top: 5px; "  >  
				<font size="2px" style="font-size: 18px;">   
			 	<b>  รหัสลูกค้า   </b>   <?php echo $codecustomerback; ?> 
				</font>
			 </div>
			 </td>
		  </tr>   
  	...
  	<table width="100%" border="0"   > 
		  ...
		  <tr>
			 ...
			 <div style="margin-left: 5px; margin-right: 5px; margin-top: 5px; "  >  
				<font size="2px" style="font-size: 18px;">   
			 	 <b>  หนังสือสัญญาเช่าซื้อ   </b>  <?php echo $name_major; ?>
				</font>
			 </div>
			 </td> 
		  </tr>   
  	...
  	<table width="100%" border="0"   > 
		  ...
		  <tr>
			 <td align="left" width="35%" valign="top" height="0px"  >  
			 <div style="margin-left: 5px; margin-right: 5px; margin-top: 5px; "  >  
				<font size="2px" style="font-size: 18px;">   
			 ...
			 <td align="left" width="30%" valign="top" height="0px"  >  
			 <div style="margin-left: 5px; margin-right: 5px; margin-top: 5px; "  >  
				<font size="2px" style="font-size: 18px;">   
  	...
  	<table width="100%" border="0"   > 
		  ...
		  <tr>
			 <td align="left" width="25%" valign="top" height="0px"  >  
			 <div style="margin-left: 5px; margin-right: 5px; margin-top: 5px; "  >  
				<font size="2px" style="font-size: 18px;">   
	...
	<font size="3px" class="serif2" color="#000" style=" font-size: 18px; ">    งวดที่    </font></div></td>   
	 
	<td width="2%"  ><div align="center"> 
	<font size="3px" class="serif2" color="#000" style=" font-size: 18px; ">    จำนวนเงิน (บาท)    </font></div></td>   
	 
	<td width="2%"  ><div align="center"> 
	<font size="3px" class="serif2" color="#000" style=" font-size: 18px; ">    วันที่ต้องโอน    </font></div></td>   
	 
	<td width="2%"  ><div align="center"> 
	<font size="3px" class="serif2" color="#000" style=" font-size: 18px; ">    วันที่ลูกค้าโอน    </font></div></td>   
	 
	<td width="6%"  ><div align="center"> 
	<font size="3px" class="serif2" color="#000" style=" font-size: 18px; ">    ผู้รับเงิน    </font></div></td>    
	...
	?>
	<tr >  								
	<td ><div align="center"><font size="3px" color="Black" style=" font-size: 15px; " > <?php echo $i; ?>  </font></div></td> 
	<td ><div align="center"><font size="3px" color="Black" style=" font-size: 15px; " > <?php echo number_format(0+$objResult2["money"]); ?>  </font></div></td> 
	<td ><div align="center"><font size="3px" color="Black" style=" font-size: 15px; " > 
	...
	<div align="left" style="margin-top: 5px;">
     ...
     <table width="70%" border="0" align="center"  style="margin-top: 5px;">
		 <tr>
			 <td align="center"> 
				<font size="2px" color="Black" style="font-size: 18px;"> ลงชื่อ...................................................................... </font>
			<br> 
	 ...
	 <font size="2px" style="font-size: 18px;">   
		 ...
		 <table width="70%">
		 	<tr>
		 		...
		 		1.	{ชื่อบัญชี}  
				<Br>
				2.	ส่งสลิปยืนยันการโอนทุกครั้ง ได้ที่ FB ⇒ เอส จี ลิสซิ่ง  ช่องทางนี้เท่านั้น   
	    		<div style="margin-left: 10px;"> 
		    	โทร  073-729950 สำนักงานใหญ่  
	    		</div>
			    </font>	
		 		</td>
		 		<td>   
		 		
		 		<img src="images/qr.jpg" style="width: 100px;" >
