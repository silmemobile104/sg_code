...
include('../database.php');
			...
			if(empty($member_user)){ 
				    ...
				    $major2_chk = "";
					$strSQL2 = "SELECT * FROM product WHERE pasy_bill = '' and pasy_createby = '".$_SESSION["UserID"]."'  Group By bill_no    ";
		...
		echo("<script>window.location = 'product_pasy.php?page2=&searchname=".$major2."&searchname2=".$major."&searchname3=&searchname4=&searchname4=';</script>");
