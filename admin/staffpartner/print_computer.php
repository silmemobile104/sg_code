    ...
    <table width="100%" border="0" align="center"  style="margin-top: 5px;">
	 <tr>
		...
		<br> 
			...
			( &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; )  </font> 
			<div style=" margin-top: -50px;"> <font color="#000"> &nbsp; </font>  </div>
			<div style=" margin-top: 5px; margin-left: 20px; "> <font color="#000"> &nbsp;   </font>  </div>
		 </td> 
		 <td align="center"> 
		...
		<br> 
			...
			<div style=" margin-top: -50px;"> <font color="#000"> &nbsp; <?php echo $name_create ; ?> </font>  </div>
			<div style=" margin-top: 5px; margin-left: 20px; "> <font color="#000"> &nbsp; <?php echo DateThai($create_date)." ".datethai2($create_date)." เวลา ".$create_time." น. ";?> </font>  </div>
		 </td> 
	 </tr> 
    </table>
