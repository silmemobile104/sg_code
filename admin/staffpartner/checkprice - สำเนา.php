                  ...
                  <div style="margin-top: 6px;" > 
                     <font size="4px" color="#000000">  เช็คราคาดาวน์   </font>   
					  ...
					  ?>
                          ...
                          <div class=" col-lg-6 " style="background-color: #FFF;  " align="center" >
						  ...
						  <input type="text" name="keydataone<?php echo $loop; ?>" id="keydataone<?php echo $loop ?>"      style=" font-size: 15px; text-align: center;  width: 100%; border: 1px solid #FFF; border-radius: 5px; height: 30px;   background-color: #FFF; margin-top: -5px;  "  onkeypress="return (event.charCode !=8 && event.charCode ==0 || ( event.charCode == 46 || (event.charCode >= 48 && event.charCode <= 57)))"  onKeyUp="Bankdata<?php echo $loop; ?>()"    autocomplete="off"     >
						  ...
						  <td style=" background-color: #FF8C00;  border: 1px solid #000;"><div align="center"><font size="3px" color="Black" style=" font-size: 15px; " > <font size="3px" color="Black" style=" font-size: 15px; " id="showone<?php echo $loop; ?>" >
							   
						  </font></div></td> 
						  <td style="background-color: #FF8C00;   border: 1px solid #000;"><div align="center"><font size="3px" color="Black" style=" font-size: 15px; " > <font size="3px" color="Black" style=" font-size: 15px; " id="showtwo<?php echo $loop; ?>" >
							  
						  </font></div></td> 
						  <td style=" background-color: #FF8C00;  border: 1px solid #000; "><div align="center"><font size="3px" color="Black" style=" font-size: 15px; " > <font size="3px" color="Black" style=" font-size: 15px; " id="showthree<?php echo $loop; ?>" >
							  
						  </font></div></td> 
						  <td style=" background-color: #FF8C00;  border: 1px solid #000; "><div align="center"><font size="3px" color="Black" style=" font-size: 15px; " > <font size="3px" color="Black" style=" font-size: 15px; " id="showfour<?php echo $loop; ?>" >
