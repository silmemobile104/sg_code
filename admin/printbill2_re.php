...
?>
  ...
  <style>
	...
	$Ngetdata1 = 0;
	$Ngetdata2 = 0;
	$sql = "SELECT * FROM payment_other_bill_no where bill_no = '".$bill_nonew ."'  order by pk asc  "; 
	 
	$query = mysqli_query($objCon,$sql);
	while($objResult = mysqli_fetch_array($query))
	{ 
		$create_date =  $objResult["date_start"]; 
		$Ngetdata1 =  $objResult["price"]; 
		$Ngetdata2 =  $objResult["discount"]; 
		
		
		$name_create = "-"; 
		$sql_p = "SELECT * FROM member_all where pk = '".$objResult["create_by"]."'   order by pk asc  "; 
		$query_p = mysqli_query($objCon,$sql_p);
		while($objResult_p = mysqli_fetch_array($query_p))
		{ 
			$name_create =  $objResult_p["name"];
		}
		
		
	}
	
	$getdata2 = $Ngetdata1 + $Ngetdata2;
	$getdata2 = $Ngetdata1 ;
    ...
    <br><br><br> 
		 ...
		 <tr>
			...
			<br> 
				...
				<div style=" margin-top: -50;  ">  <font size="2px" color="Black" style=" font-size: 18px;"> &nbsp; </font>  </div>
			 </td> 
			 <td align="center"> 
			...
			<br> 
				...
				<div style=" margin-top: -50;  ">  <font size="2px" color="Black" style=" font-size: 18px;"> <?php echo $name_create; ?> </font>  </div>
			 </td> 
		 </tr> 
	  </table>                      
