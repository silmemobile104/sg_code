              ...
              <div class=" col-lg-12 "  style="margin-top: -15px;"  > 
                <div class="x_panel"  style="background-color: #FFFFFF;  border-radius: 10px; " > 
                  ...
                  <div style="margin-top: 6px;" > 
					...
					where a.bill_no != '' and a.tanaidata = '".$tanaidata."'  and a.tanai_chk = '' and a.tanaidata != ''    
					".$addcode.$addcode2."  
					order by a.pk asc    "; 
					...
					<?php if (ceil($total_record / $perpage) > 0): ?>
						 <ul class="pagination">
						<?php if ($page > 1): ?>
						<li class="prev"><a href="paper_tanai3.php?page2=<?php echo $page-1 ?>&searchname=<?php echo $searchname; ?>&searchname2=<?php echo $searchname2; ?>&searchtype=<?php echo $searchtype; ?>&bill_no=<?php echo $bill_no; ?>&tanaidata=<?php echo $tanaidata; ?>">Prev</a></li>
						<?php endif; ?>

						<?php if ($page > 3): ?>
						<li class="start"><a href="paper_tanai3.php?page2=1&searchname=<?php echo $searchname; ?>&searchname2=<?php echo $searchname2; ?>&searchtype=<?php echo $searchtype; ?>&bill_no=<?php echo $bill_no; ?>&tanaidata=<?php echo $tanaidata; ?>">1</a></li>
						<li class="dots">...</li>
						<?php endif; ?>

						<?php if ($page-2 > 0): ?><li class="page"><a href="paper_tanai3.php?page2=<?php echo $page-2 ?>&searchname=<?php echo $searchname; ?>&searchname2=<?php echo $searchname2; ?>&searchtype=<?php echo $searchtype; ?>&bill_no=<?php echo $bill_no; ?>&tanaidata=<?php echo $tanaidata; ?>"><?php echo $page-2 ?></a></li><?php endif; ?>
						<?php if ($page-1 > 0): ?><li class="page"><a href="paper_tanai3.php?page2=<?php echo $page-1 ?>&searchname=<?php echo $searchname; ?>&searchname2=<?php echo $searchname2; ?>&searchtype=<?php echo $searchtype; ?>&bill_no=<?php echo $bill_no; ?>&tanaidata=<?php echo $tanaidata; ?>"><?php echo $page-1 ?></a></li><?php endif; ?>

						<li class="currentpage"><a href="paper_tanai3.php?page2=<?php echo $page ?>&searchname=<?php echo $searchname; ?>&searchname2=<?php echo $searchname2; ?>&searchtype=<?php echo $searchtype; ?>&bill_no=<?php echo $bill_no; ?>"><?php echo $page ?></a></li>

						<?php if ($page+1 < ceil($total_record / $perpage)+1): ?><li class="page"><a href="paper_tanai3.php?page2=<?php echo $page+1 ?>&searchname=<?php echo $searchname; ?>&searchname2=<?php echo $searchname2; ?>&searchtype=<?php echo $searchtype; ?>&bill_no=<?php echo $bill_no; ?>&tanaidata=<?php echo $tanaidata; ?>"><?php echo $page+1 ?></a></li><?php endif; ?>
						<?php if ($page+2 < ceil($total_record / $perpage)+1): ?><li class="page"><a href="paper_tanai3.php?page2=<?php echo $page+2 ?>&searchname=<?php echo $searchname; ?>&searchname2=<?php echo $searchname2; ?>&searchtype=<?php echo $searchtype; ?>&bill_no=<?php echo $bill_no; ?>&tanaidata=<?php echo $tanaidata; ?>"><?php echo $page+2 ?></a></li><?php endif; ?>

						<?php if ($page < ceil($total_record / $perpage)-2): ?>
						<li class="dots">...</li>
						<li class="end"><a href="paper_tanai3.php?page2=<?php echo ceil($total_record / $perpage) ?>&searchname=<?php echo $searchname; ?>&searchname2=<?php echo $searchname2; ?>&searchtype=<?php echo $searchtype; ?>&bill_no=<?php echo $bill_no; ?>&tanaidata=<?php echo $tanaidata; ?>"><?php echo ceil($total_record / $perpage) ?></a></li>
						<?php endif; ?>

						<?php if ($page < ceil($total_record / $perpage)): ?>
						<li class="next"><a href="paper_tanai3.php?page2=<?php echo $page+1 ?>&searchname=<?php echo $searchname; ?>&searchname2=<?php echo $searchname2; ?>&searchtype=<?php echo $searchtype; ?>&bill_no=<?php echo $bill_no; ?>&tanaidata=<?php echo $tanaidata; ?>">Next</a></li>
						<?php endif; ?>
					</ul>
					<?php endif; ?>
					...
					<?php 
						...
						<input type="hidden" id="totalall" value="<?php echo $i; ?>">
						<input type="hidden" id="tanaidata" value="<?php echo $tanaidata; ?>">
					...
					<script>  
					 ...
					 {
					  var tanaidata = document.getElementById("tanaidata").value;  
 
						 	/////  alert("loadalltotal_tanai_select.php?tanaidata="+tanaidata);
						 
							$.ajax({
							type: "GET",
							url: "loadalltotal_tanai_select.php?tanaidata="+tanaidata,
						 ...
						 for(loop = 1; loop <= totalall; loop++){
							 var savepk =	document.getElementById("datasaveproduct"+loop).value;  
								...
								//// alert("save_cart.php?savepk="+savepk+"&total="+gettotal);
								 $.ajax({
								 type: "POST",
								 url: "save_tanal_bill_pasy.php?savepk="+savepk,
								 data: {},
								 success: function(result) {
									  Getsearchdata(); 
								 }
					...
					?>	 
					  ...
					  <div class="col-lg-12"  align="left"  > 
							...
							<a href="paper_tanai3_select.php?tanaidata=<?php echo $tanaidata; ?>">
					...
					<tr style="background-color: <?php echo $bg ?>; " id="hdd<?php echo $i; ?>"> 
					 ...
					 <a onClick="Saveordercart<?php echo $i; ?>()"   > 
						<button type="button" class="btn btn-sm" style="background-color: #0199A7; border-radius: 5px;  border-color: #0199A7; margin-top: 5px; "  > <font color="#FFF" size="2px" class="serif1" style="  font-size: 13px; " >    เลือก   </font> </button>   
					 </a>
